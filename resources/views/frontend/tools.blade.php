                        ...
                        <div>
                            <div class="category-wrapper pt-0">
                                <div>
                                    ...
                                    <a href="category-page.html" class="btn btn-outline btn-classic">view more</a>
                                </div>
                            </div>
                        </div>
                        <div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="product-4 product-m no-arrow">
                        <div>
                            <div class="basic-product theme-product-1 bg-white">
                                <div class="overflow-hidden">
                                    <div class="img-wrapper">
                                        <a href="product-page(accordian).html">
                                            <img src="../assets/images/tools/product/1.jpg"
                        ...
                        <div>
                            <div class="basic-product theme-product-1 bg-white">
                                <div class="overflow-hidden">
                                    <div class="img-wrapper">
                                        <a href="product-page(accordian).html"><img
                                                src="../assets/images/tools/product/4.jpg"
                                                class="img-fluid blur-up lazyload" alt=""></a>
                                        <div class="rating-label"><i class="fa fa-star"></i>
                                            <span>4.5</span>
                                        </div>
                                    ...
                                    <div class="product-detail">
                                        <div>
                                            <div class="brand-w-color">
                                                <a class="product-title" href="product-page(accordian).html">
                                                    Automative Battery </a>

                                            </div>
                                            <h6>Fuel Injaction Tester </h6>
                                            <h4 class="price">$ 12.79<del> $15.00 </del><span class="discounted-price">
                                                    7% Off
                                                </span>
                                            </h4>
                                        </div>
                        ...
                        <div>
                            <div class="basic-product theme-product-1 bg-white">
                                <div class="overflow-hidden">
                                    <div class="img-wrapper">
                                        <a href="product-page(accordian).html"><img
                                                src="../assets/images/tools/product/5.jpg"
                                                class="img-fluid blur-up lazyload" alt=""></a>
                                        <div class="rating-label"><i class="fa fa-star"></i>
                                            <span>4.5</span>
                                        </div>
                                    ...
                                    <div class="product-detail">
                                        <div>
                                            <div class="brand-w-color">
                                                <a class="product-title" href="product-page(accordian).html">
                                                    AutoTech Solutions </a>

                                            </div>
                                            <h6> Automative Battery </h6>
                                            <h4 class="price">$ 18.65<del> $20.00 </del><span class="discounted-price">
                                                    7% Off
                                                </span>
                                            </h4>
                                        </div>
    ...
    <section class="full-banner parallax small-slider tools-parallax-product">
        <img src="../assets/images/tools/full-banner/2.png" alt="" class="bg-img blur-up lazyload">
        <div class="container">
            <div class="g-3 g-md-4 row row-cols-2 row-cols-md-3 row-cols-lg-4">
                <div>
                    <div class="basic-product theme-product-1 bg-white">
                        <div class="overflow-hidden">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html">
                                    <img src="../assets/images/tools/product/6.jpg" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                                <div class="rating-label"><i class="ri-star-fill"></i><span>4.5</span>
                                </div>
                ...
                <div>
                    <div class="basic-product theme-product-1 bg-white">
                        <div class="overflow-hidden">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/tools/product/7.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="rating-label"><i class="fa fa-star"></i>
                                    <span>4.5</span>
                                </div>
                            ...
                            <div class="product-detail">
                                <div>
                                    ...
                                    <h6> Portable Inverter Welder </h6>
                                    <h4 class="price">$ 3.40 </h4>
                                </div>
                                <ul class="offer-panel">
                                    <li><span class="offer-icon"><i class="ri-discount-percent-fill"></i></span>
                ...
                <div>
                    <div class="basic-product theme-product-1 bg-white">
                        <div class="overflow-hidden">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/tools/product/8.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="rating-label"><i class="fa fa-star"></i>
                                    <span>4.5</span>
                                </div>
                ...
                <div>
                    <div class="basic-product theme-product-1 bg-white">
                        <div class="overflow-hidden">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/tools/product/9.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="rating-label"><i class="fa fa-star"></i>
                                    <span>4.5</span>
                                </div>
        ...
        <div class="container">
            <div class="row multiple-slider">
                            ...
                            <div>
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center">
                                        ...
                                        <a href="product-page(accordian).html">
                                            <h6>Auto Battery Transparent</h6>
                                        </a>
                                        <h4>$100.00 <del>$150.00</del></h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                            ...
                            <div>
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center">
                                        ...
                                        <a href="product-page(accordian).html">
                                            <h6>Wireless USB Transmitter</h6>
                                        </a>
                ...
                <div class="col-xl-9 col-lg-8 col-md-12 tools-grey">
                                            ...
                                            <div class="overflow-hidden">
                                                ...
                                                <div class="product-detail">
                                                    <div>
                                                        ...
                                                        <h6>Fuel Injaction Tester </h6>
                                                        <h4 class="price">$ 12.79<del> $15.00 </del><span
                                                                class="discounted-price">
                                                                7% Off
                                                            </span>
                                                        </h4>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-1 bg-white">
                                            <div class="overflow-hidden">
                                                <div class="img-wrapper">
                                                    <a href="product-page(accordian).html">
                                                        <img src="../assets/images/tools/product/6.jpg"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <div class="rating-label"><i
                                                            class="ri-star-fill"></i><span>4.5</span>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-1 bg-white">
                                            <div class="overflow-hidden">
                                                <div class="img-wrapper">
                                                    <a href="product-page(accordian).html"><img
                                                            src="../assets/images/tools/product/7.jpg"
                                                            class="img-fluid blur-up lazyload" alt=""></a>
                                                    <div class="rating-label"><i class="fa fa-star"></i>
                                                        <span>4.5</span>
                                                    </div>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-1 bg-white">
                                            <div class="overflow-hidden">
                                                <div class="img-wrapper">
                                                    <a href="product-page(accordian).html"><img
                                                            src="../assets/images/tools/product/8.jpg"
                                                            class="img-fluid blur-up lazyload" alt=""></a>
                                                    <div class="rating-label"><i class="fa fa-star"></i>
                                                        <span>4.5</span>
                                                    </div>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-1 bg-white">
                                            <div class="overflow-hidden">
                                                <div class="img-wrapper">
                                                    <a href="product-page(accordian).html"><img
                                                            src="../assets/images/tools/product/9.jpg"
                                                            class="img-fluid blur-up lazyload" alt=""></a>
                                                    <div class="rating-label"><i class="fa fa-star"></i>
                                                        <span>4.5</span>
                                                    </div>
                    ...
                    <a href="category-page.html" class="banner-tools">
                        <img src="../assets/images/tools/banner/1.png" alt="" class="img-fluid">
                    </a>
                </div>
            </div>
        </div>
