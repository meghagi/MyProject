                    ...
                    <div class="dashboard-sidebar">
                        ...
                        <div class="faq-tab">
                            <ul id="pills-tab" role="tablist" class="nav nav-tabs">
                                ...
                                <li role="presentation" class="nav-item">
                                    <a href="{{url('/addtocart')}}">  <button class="nav-link" id="addtocart-tab" data-bs-toggle="tab"
                                           data-bs-target="#addtocart-tab-pane" type="button" role="tab">
                                           <i class="fas fa-shopping-cart"></i> Add to Cart
                                       </button></a>
                                   </li>
                                   <a href="{{url('/wishlist')}}"> <li role="presentation" class="nav-item">
                                   ...
                                   <li role="presentation" class="nav-item">
                                    <a href="{{url('/addwishlist')}}">  <button class="nav-link" id="addwishlist-tab" data-bs-toggle="tab"
                                           data-bs-target="#addwishlist-tab-pane" type="button" role="tab">
                                           <i class="fas fa-heart"></i> Addwishlist
                                       </button></a>
                                   </li>
                                   <li role="presentation" class="nav-item">
                                   <a href="{{url('/ordertracking')}}"><button class="nav-link" id="order-tab" data-bs-toggle="tab"
                                           data-bs-target="#order-tab-pane" type="button" role="tab">
                                           <i class="ri-file-text-line"></i>My Orders
                                       </button></a>
                                   </li>
                                   <a href="{{url('/profile')}}"> <li role="presentation" class="nav-item">
                                       <button class="nav-link" id="refund-tab" data-bs-toggle="tab"
                                           data-bs-target="#refund-tab-pane" type="button" role="tab">
                                           <i class="ri-money-dollar-circle-line"></i> Profile </button></a>
                                   </li>
                                   <li role="presentation" class="nav-item">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card mb-0 mt-0">
                                    <div class="card-body">
                                        <div class="top-sec">
                                            <form action="{{ route('continueshopping1') }}" name="myForm" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row mb-3 align-items-center">
                                                    <div class="col-xxl-2 col-lg-12 col-md-5">
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    <div class="col-xxl-2 col-lg-12 col-md-3">
                                                        <label for="description" class="form-label">PhoneNumber</label>
                                                    </div>&nbsp;&nbsp;
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="PhoneNumber" class="form-control" name="PhoneNumber" placeholder="Enter PhoneNumber">
                                                        <span class="text-danger">
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    <div class="col-xxl-2 col-lg-12 col-md-3">
                                                        <label for="adderess" class="form-label">adderess</label>
                                                    </div>&nbsp;&nbsp;
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="adderess" class="form-control" name="adderess" placeholder="Enter adderess">
                                                        <span class="text-danger">
                                                            @error('adderess') {{ $message }} @enderror
                                                        </span>
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="total_price" class="form-control" name="total_price" placeholder="Enter total_price">
                                                        <span class="text-danger">
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    <div class="col-xxl-2 col-lg-12 col-md-3">
                                                        <label for="billing_date" class="form-label">billing_date</label>
                                                    </div>&nbsp;&nbsp;
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="date" id="billing_date" class="form-control" name="billing_date" placeholder="Enter billing_date">
                                                        <span class="text-danger">
                                                            @error('billing_date') {{ $message }} @enderror
                                                        </span>
                                                ...
                                                {{--<div class="row mb-3 align-items-center">
                                                    <div class="col-xxl-2 col-lg-12 col-md-3">
                                                        <label for="total_price" class="form-label">order_status</label>
                                                    </div>&nbsp;&nbsp;
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <select name="order_status">
                                                            ...
                                                            <!-- Add categories dynamically from your DB -->
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                {{--<div class="row mb-3 align-items-center">
                                                    <div class="col-xxl-2 col-lg-12 col-md-3">
                                                        <label for="price" class="form-label">Stock(Cost)Price</label>
                                                    </div>
                                                   
                                                <div class="col-xxl-10 col-lg-12 col-md-9">
                                                    <input type="text" id="ifsc" class="form-control" value="{{$category->stock}}"placeholder="Enter stock" name="stock"
                                            ...
                                            <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="file" id="file1" class="form-control" name="file"value="{{$category->image}}">
                                                        <span class="text-danger">
