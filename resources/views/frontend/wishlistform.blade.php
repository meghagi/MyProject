...
<!-- header end -->
            ...
            <div class="row">
                        ...
                        <div class="faq-tab">
                            <ul id="pills-tab" role="tablist" class="nav nav-tabs">
                              ...
                              {{-- <li role="presentation" class="nav-item">
                                ...
                                <li role="presentation" class="nav-item">
                                 <button class="nav-link" id="addtocart-tab" data-bs-toggle="tab"
                                ...
                                <a href="{{url('/wishlist')}}"> <li role="presentation" class="nav-item">
                                 ...
                                 <li role="presentation" class="nav-item">
                                 <button class="nav-link" id="addwishlist-tab" data-bs-toggle="tab"
                ...
                <div class="col-lg-9">
                    ...
                    <div class="faq-content tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="addwishlist-tab-pane" role="tabpanel">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card mb-0 mt-0">
                                        <div class="card-body">
                                            ...
                                            <form   action="{{url('/wishliststore')}}"name="myForm" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row mb-3 align-items-center">
                                                <div class="form-group">
			
                                                <div class="form-group row">
    <label for="product" class="form-label col-xxl-2 col-lg-12 col-md-3">Product Id</label>
    <div class="col-xxl-10 col-lg-12 col-md-9">
    ...
    @endforeach
            <!-- Add more products dynamically from your database -->
                                                ...
                                                <div class="form-group row">
    <label for="product" class="form-label col-xxl-2 col-lg-12 col-md-3">Customer Id</label>
    <div class="col-xxl-10 col-lg-12 col-md-9">
    ...
    @endforeach
            <!-- Add more products dynamically from your database -->
                                                ...
                                                <div class="form-group row">
    <label for="orderid" class="form-label col-xxl-2 col-lg-12 col-md-3">Order Id</label>
    <div class="col-xxl-10 col-lg-12 col-md-9">
        <select name="Orderid" id="Orderid" class="form-select">
        <option value="">Select</option>
        @foreach($orderitem as $orderitem1)
        <option value="{{ $orderitem1->id }}">{{ $orderitem1->id }}</option>
    @endforeach
    </select>
    </div>
                                            ...
                                            <div class="row mb-3 align-items-center">
                                                <div class="form-group">
                                                    <label for="description"
                                                        class="form-label col-xxl-2 col-lg-12 col-md-3">Description
                        </label>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9"><input type="text"
                                               ...
                                               <div class="row mb-3 align-items-center">
                                                ...
                                                <div class="form-group">
                                                    <label for="Price"
                                                        class="form-label col-xxl-2 col-lg-12 col-md-3">Price</label>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                               ...
                                               {{--<div class="row mb-3 align-items-center">
                                                <div class="form-group">
                                                    <label for="ifsc"
                                                        class="form-label col-xxl-2 col-lg-12 col-md-3">Stock(Cost)Price</label>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="ifsc" class="form-control" name="Cost"
                                        ...
                                        <div class="mb-3 top-sec top-sec-2">
                                            ...
                                            <form class="themeform-auth">
                                                <div class="row mb-3 align-items-center">
                                                    <label for="paypal_email"
                                                        class="form-label col-xxl-2 col-lg-12 col-md-3">Upload
                                                        </label>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
