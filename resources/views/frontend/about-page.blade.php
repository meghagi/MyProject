    ...
    <div class="breadcrumb-section">
        <div class="container">
            ...
            <nav class="theme-breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="https://vidhyasagarfoundation.intouchsoftwaresolution.com/">vidhyasagarfoundation.intouchsoftwaresolution.com</a></li>
                    {{-- <li class="breadcrumb-item">
                        <a href="{{url('/index')}}">Home</a>
                    </li>
                    
                    <li style="margin-top:10px;" >About us</li> --}}
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-section"><img src="{{url('uploads/img5.jpeg')}}"
                            class="img-fluid blur-up lazyload" alt="" style="width:120%;"></div>
                </div>
                <div class="col-sm-12">
                    <h4> Ecommerce Stationary
                    </h4>
                    
                    <p>E-commerce stationery refers to the online sale and purchase of office, school, and personal stationery supplies through digital platforms. This niche within the e-commerce industry caters to a wide audience, including students, professionals, businesses, and artists, by offering convenience and variety.

                        .E-commerce stationery is a business model that connects buyers and sellers of stationery products on a digital platform. The goal of these online stores is to provide a convenient shopping experience and facilitate transactions</p>
    ...
    <section class="testimonial small-section">
        <div class="container">
            <div class="title1">
                ...
                <h2 class="title-inner1">What  Stationary</h2>
            </div>
            <div class="slide-2 testimonial-slider no-arrow">
                <div>
                    <div class="media">
                        <div class="text-center">
                            <img src="{{url('uploads/crayons.jpg')}}" alt="#">
                            <h5>Mark Junco</h5>
                            <h6>Designer</h6>
                        </div>
                        <div class="media-body">
                            <p>Stationery is more than just a collection of tools; it is the bridge between thought and expression, creativity and realization. The term "stationery" traditionally refers to writing materials and office supplies, but it embodies the timeless charm of paper, ink, and the tools that bring ideas to life.
