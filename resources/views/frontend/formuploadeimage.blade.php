...
Manage Sales
                ...
                <div class="col-lg-9">
                    ...
                    <div class="faq-content tab-content" id="myTabContent">
                            ...
                            <div class="counter-section">
                                ...
                                <div class="box-account box-info">
                                    ...
                                    <div class="box mt-3">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <h6>Email : admin12@gmail.com</h6><a href="#edit-profile"
                        ...
                        <div class="tab-pane fade" id="upload-product-tab-pane" role="tabpanel">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card mb-0 mt-0">
                                        <div class="card-body">
                                            ...
                                            <form   action="{{url('/upload-multiple-images1')}}"name="myForm" method="post" enctype="multipart/form-data">
                                                @csrf
                                                {{-- <div class="row mb-3 align-items-center">
                     ...
                     @enderror
                                            ...
                                            <form class="themeform-auth">
                                                <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="file" id="file1" class="form-control " name="file1[]"multiple accept="image/*" required
