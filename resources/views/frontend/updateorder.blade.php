                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card mb-0 mt-0">
                                    <div class="card-body">
                                        <div class="top-sec">
                                            <form action="{{ route('updateorderdata', ['id' => $order->id]) }}" name="myForm" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row mb-3 align-items-center">
                                                    <div class="col-xxl-2 col-lg-12 col-md-3">
                                                        <label for="Customername" class="form-label">Productid</label>
                                                    </div>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <label for="product" class="form-label col-xxl-2 col-lg-12 col-md-3">Product Id</label>
                                                        <div class="col-xxl-10 col-lg-12 col-md-9">
                                                            <select name="productid" id="productid" class="form-select" name="productid"value="{{$order->productid}}">
                                                                <option value="1" {{ $order->productid == 1 ? 'selected' : '' }}>1</option>
                                                                <option value="2" {{ $order->productid == 2 ? 'selected' : '' }}>2</option>
                                                                <option value="3" {{ $order->productid == 3 ? 'selected' : '' }}>3</option>
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="Quantity" class="form-control" name="Quantity"value="{{$order->quantity}}" placeholder="Enter Email">
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="price" class="form-control" name="price" value="{{$order->price}}"placeholder="Enter price">
                                                        <span class="text-danger">
