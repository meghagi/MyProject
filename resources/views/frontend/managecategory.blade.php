...
<li role="presentation" class="nav-item">
 <button class="nav-link" id="add-category-tab" data-bs-toggle="tab"
                                        data-bs-target="#manage-category-tab-pane" type="button" role="tab">
...
<li role="presentation" class="nav-item">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="faq-content tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="manage-category-tab-pane" role="tabpanel">
                            <div class="row g-3">
                                <div class="col-12">
                                                        ...
                                                        <table class="table cart-table order-table yajra_datatable"style="width:100px;">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><img src="{{ asset('uploads/' . $categories->image) }}" width="50px"></td>
                                                                    <!-- <td>{{$categories->image}}</td> -->
                                                                    <td>{{$categories->status}}</td>
                                                                    <td style="width:400px;">
<a href="{{Route('deletecategory',['id'=>$categories->id])}}"title="Change Status" id="{{$categories->id}}"class="delete_btn_ajax " data-toggle="tooltip"><span class="fas fa-trash"></a><input type="hidden" class="delete_id_value" value='{{$categories->id}}'>

    <a href="{{Route('editcategory',['id'=>$categories->id])}}"  title="Edit Details" data-toggle="tooltip">
        <span class="fa fa-pencil" style="color: yellow;"></span>
                            </a>

                            <a href="{{Route('readcategory',['id'=>$categories->id])}}"  title="Edit Details" data-toggle="tooltip">
