...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/goggles.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2024 09:28:29 GMT -->
<head>
    ...
    <link rel="icon" href="../assets/images/goggles/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="../assets/images/goggles/favicon.png" type="image/x-icon">
...
<body class="theme-color-8">
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                ...
                                <div class="brand-logo">
                                    <a href="index-2.html"><img src="../assets/images/goggles/logo.png"
                ...
                <div class="col-sm-12">
                    <div class="main-menu">
                        <div class="menu-left">
                            ...
                            <div class="brand-logo"><a href="index-2.html"><img src="../assets/images/goggles/logo.png"
    ...
    <section class="p-0">
        <a href="category-page.html" class="home">
            <img src="../assets/images/goggles/full-banner/1.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- Home slider end -->
    ...
    <!-- collection banner -->
    <section class="section-b-space banner-goggles ratio2_1 banner-section">
        <div class="container">
            <div class="row g-4">
                <div class="col-md-4">
                    <a href="category-page.html">
                        <div class="collection-banner p-left">
                            <img src="../assets/images/goggles/banner/1.png" class="img-fluid blur-up lazyload" alt="">
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="category-page.html">
                        <div class="collection-banner p-left text-start">
                            <img src="../assets/images/goggles/banner/2.png" class="img-fluid blur-up lazyload" alt="">
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="category-page.html">
                        <div class="collection-banner p-left">
                            <img src="../assets/images/goggles/banner/3.png" class="img-fluid blur-up lazyload" alt="">
                        </div>
                    </a>
                </div>
            </div>
    ...
    <!-- Product slider -->
    <section class="layout9-box section-b-space ratio_asos pt-0">
        <div class="container">
            <div class="title3">
                    ...
                    <div class="product-4 product-m no-arrow">
                        <div class="basic-product theme-product-8">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/goggles/product/1.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                            ...
                            <div class="product-detail">
                                <a class="product-title" href="product-page(accordian).html">
                                    Gradiant Glassses </a>
                                <h4 class="price mb-2">$ 90.20<del> $95.00 </del><span class="discounted-price"> 10%
                                        Off
                                    </span>
                                </h4>
                        ...
                        <div class="basic-product theme-product-8">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/goggles/product/2.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <a href="#!" title="Add to Wishlist" class="wishlist-icon">
                                        <i class="ri-heart-line"></i>
                        ...
                        <div class="basic-product theme-product-8">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/goggles/product/3.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <a href="#!" title="Add to Wishlist" class="wishlist-icon">
                                        <i class="ri-heart-line"></i>
                            ...
                            <div class="product-detail">
                                <a class="product-title" href="product-page(accordian).html">
                                    Thalia Optics </a>
                                <h4 class="price mb-2">$ 50.49<del> $55.20 </del><span class="discounted-price"> 12%
                                        Off
                                    </span>
                                </h4>
                                <div class="rating-w-count mb-0">
                        ...
                        <div class="basic-product theme-product-8">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/goggles/product/4.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <a href="#!" title="Add to Wishlist" class="wishlist-icon">
                                        <i class="ri-heart-line"></i>
                        ...
                        <div class="basic-product theme-product-8">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/goggles/product/5.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <a href="#!" title="Add to Wishlist" class="wishlist-icon">
                                        <i class="ri-heart-line"></i>
    ...
    <section class="p-0">
        <a href="#!">
            <img src="../assets/images/goggles/full-banner/2.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- Parallax banner end -->
                ...
                <div class="col">
                    <div class="theme-tab">
                        <ul class="tabs tab-title2">
                            <li class="current"><a href="tab-1.html">trending proudct</a></li>
                            <li><a href="tab-2.html">special deal</a></li>
                        </ul>
                            ...
                            <div id="tab-2" class="tab-content">
                                <div class="product-4 product-m no-arrow">
                                    ...
                                    <div class="basic-product theme-product-8">
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/goggles/product/7.jpg"
                                                    class="img-fluid blur-up lazyload" alt=""></a>
                                            <div class="cart-info">
                                                <a href="#!" title="Add to Wishlist" class="wishlist-icon">
                                                    <i class="ri-heart-line"></i>
                                    ...
                                    <div class="basic-product theme-product-8">
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/goggles/product/8.jpg"
                                                    class="img-fluid blur-up lazyload" alt=""></a>
                                            <div class="cart-info">
                                                <a href="#!" title="Add to Wishlist" class="wishlist-icon">
                                                    <i class="ri-heart-line"></i>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="slide-5 no-arrow slick-instagram">
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/goggles/instagram/1.png"
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/goggles/instagram/2.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/goggles/instagram/3.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/goggles/instagram/4.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/goggles/instagram/5.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
