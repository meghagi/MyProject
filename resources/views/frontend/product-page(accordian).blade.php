                        ...
                        <div class="col-lg-4">
                            <div class="product-slick">
                                ...
                                <div><img src="../assets/images/product-details/product/19.jpg" alt=""
                                        class="w-100 img-fluid blur-up lazyload"></div>
                           <div class="trending-text ">     <div><img src="../assets/images/product-details/product/18.jpg" alt=""
                                        class="w-100 img-fluid blur-up lazyload"></div> --}}
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="qty-section">
                                        <div class="qty-box">
                                            ...
                                            <div class="input-group">
                                                ...
                                                value="1" min="1" max="{{$products->quantity}}">
                                                <span class="input-group-prepend">
                                                    <button type="button" class="btn quantity-right-plus"
                                                        data-type="plus" data-field="">
                                                        <i class="ri-arrow-right-s-line"></i>
                                                    </button>
                                                    {{-- <a href="{{ Route('addtocart1',['id'=>$products->id,'name'=>$products->product_name])}}"> 
