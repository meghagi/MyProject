    ...
    <section class="p-0">
        <a href="category-page.html">
            <img src="../assets/images/vegetables-1/full-banner/1.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- Home slider end -->
    ...
    <section class="p-0">
        <a href="category-page.html">
            <img src="../assets/images/vegetables-1/full-banner/2.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- Parallax banner end -->
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/vegetables-1/blog/1.png"
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/vegetables-1/blog/2.png"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/vegetables-1/blog/3.png"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
