                    ...
                    <div class="col-lg-6 rtl-text position-relative">
                        <div class="product-page-details">
                            ...
                            <div class="price-text">
                                <h3><span class="fw-normal">MRP:</span>  @foreach($product as $products)
                                    <p>{{$products->price}}</p>
                                    @endforeach
                                    <del> $
                            ...
                            <div class="variation-box mt-3">
                                ...
                                <ul class="image-box">
                                    <li class="active">
                                        <img src="{{ asset('uploads/img14.jpeg') }}" alt="">
                                    </li>
                                    <li>
                                        <img src="{{asset('uploads/img15.jpg')}}" alt="">
                                    </li>
                                    <li>
                                        <img src="{{ asset('uploads/img17.jpg') }}" alt="">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="slider-nav">
                                    <div>
                                        <img src="{{ asset('uploads/img14.jpeg') }}" alt=""class="img-fluid blur-up lazyload">
                                    </div>
                                    <div>
                                        <img src="{{asset('uploads/img15.jpg')}}" alt=""class="img-fluid blur-up lazyload">
                                    </div>
                                    <div>
                                        <img src="{{ asset('uploads/img17.jpg') }}" alt=""class="img-fluid blur-up lazyload">
                                    </div>
                            ...
                            <div class="tab-pane fade show active" id="top-home" role="tabpanel"
                                ...
                                <div class="product-tab-description">
                                    <div class="part">
                                        ...
                                        <p>For a Premium or Stylish Rubber:
                                            "This premium eraser offers a blend of style and functionality. Its sleek design and non-abrasive texture make it ideal for precise corrections, ensuring your work stays neat and professional.".</p>
                            ...
                            <div class="tab-pane fade" id="top-contact" role="tabpanel"
                                ...
                                <div class="post-question-box">
                                    <h4>Have Doubts Regarding This Product ? <a href="#ask-question"
                                            data-bs-toggle="modal">Post Your Question</a>
                                    </h4>
                                </div>
