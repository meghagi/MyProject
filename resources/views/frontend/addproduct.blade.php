                        ...
                        <div class="faq-tab">
                            <ul id="pills-tab" role="tablist" class="nav nav-tabs">
                                <li role="presentation" class="nav-item">
                                    <button class="nav-link active" id="info-tab" data-bs-toggle="tab" data-bs-target="#info-tab-pane" type="button" role="tab" fdprocessedid="3r6zpu" aria-selected="true">
...
Manage Sales
                               ...
                               <a href="{{url('/orderstock')}}"> <button class="nav-link" id="order-tab" data-bs-toggle="tab"
                                ...
                                <a href="{{url('/upload-multiple-images')}}"><li role="presentation" class="nav-item">
                                    <button class="nav-link" id="upload-product-tab" data-bs-toggle="tab"
                                data-bs-target="#upload-product-tab-pane" type="button" role="tab">
                                ...
                                <div class="col-12">
                                    <div class="card mb-0 mt-0">
                                        <div class="card-body">
                                            ...
                                            <form   action="{{url('/productstore')}}"name="myForm" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row mb-3 align-items-center">
                                                <div class="form-group">
			
                                                    <label for="productname"
                                                        class="form-label col-xxl-2 col-lg-12 col-md-3">Product Name</label>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
