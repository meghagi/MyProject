    ...
    <section class="p-0">
        <a href="category-page.html" class="home">
            <img src="../assets/images/jewellery-2/full-banner/1.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- Home slider end -->
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <a href="category-page.html">
                        <div class="collection-banner p-left text-start">
                            <div class="img-part">
                                <img src="../assets/images/jewellery-2/banner/1.png" alt=""
                ...
                <div class="col-md-4">
                    <a href="category-page.html">
                        <div class="collection-banner p-left text-start">
                            <div class="img-part">
                                <img src="../assets/images/jewellery-2/banner/2.png" alt=""
                                    class="img-fluid blur-up lazyload">
                            </div>
                ...
                <div class="col-md-4">
                    <a href="category-page.html">
                        <div class="collection-banner p-left text-start">
                            <div class="img-part">
                                <img src="../assets/images/jewellery-2/banner/3.png" alt=""
                                    class="img-fluid blur-up lazyload">
                            </div>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <a href="category-page.html">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../assets/images/jewellery-2/banner/4.png" alt=""
                                    class="img-fluid blur-up lazyload">
                            </div>
                ...
                <div class="col-md-6">
                    <a href="category-page.html">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../assets/images/jewellery-2/banner/5.png" alt=""
                                    class="img-fluid blur-up lazyload">
                            </div>
    ...
    <!-- category -->
    <div class="container">
        <section class="section-b-space border-section border-top-0 category-rounded">
            <div class="row">
                <div class="col">
                    <div class="slide-6 no-arrow">
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image svg-image">
                                    <svg>
                                        <use xlink:href="https://themes.pixelstrap.com/multikart/assets/svg/icons.svg#rings"></use>
                                    </svg>
                                </div>
                            </a>
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image svg-image">
                                    <svg>
                                        <use xlink:href="https://themes.pixelstrap.com/multikart/assets/svg/icons.svg#diamonds"></use>
                                    </svg>
                                </div>
                            </a>
                            <div class="category-details">
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image svg-image">
                                    <svg>
                                        <use xlink:href="https://themes.pixelstrap.com/multikart/assets/svg/icons.svg#neckles"></use>
                                    </svg>
                                </div>
                            </a>
                            <div class="category-details">
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image svg-image">
                                    <svg>
                                        <use xlink:href="https://themes.pixelstrap.com/multikart/assets/svg/icons.svg#watches"></use>
                                    </svg>
                                </div>
                            </a>
                            <div class="category-details">
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image svg-image">
                                    <svg>
                                        <use xlink:href="https://themes.pixelstrap.com/multikart/assets/svg/icons.svg#pearsing"></use>
                                    </svg>
                                </div>
                            </a>
                            <div class="category-details">
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image svg-image">
                                    <svg>
                                        <use xlink:href="https://themes.pixelstrap.com/multikart/assets/svg/icons.svg#tiara"></use>
                                    </svg>
                                </div>
                            </a>
                            <div class="category-details">
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image svg-image">
                                    <svg>
                                        <use xlink:href="https://themes.pixelstrap.com/multikart/assets/svg/icons.svg#earrings"></use>
                                    </svg>
                                </div>
                            </a>
                            <div class="category-details">
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image svg-image">
                                    <svg>
                                        <use xlink:href="https://themes.pixelstrap.com/multikart/assets/svg/icons.svg#longearrings"></use>
                                    </svg>
                                </div>
                            </a>
                            <div class="category-details">
    ...
    <div class="title6 section-t-space">
        <h2 class="font-cormorant">top collection</h2>
    </div>
    <div class="container">
        <div class="row">
    ...
    <div class="bag-product ratio_square section-b-space">
        <div class="container">
            <div class="g-3 g-md-4 row row-cols-2 row-cols-md-3 row-cols-xl-4">
                <div>
                    <div class="basic-product theme-product-11">
                        <div class="img-wrapper">
                            <a href="product-page(accordian).html"><img src="../assets/images/jewellery-1/product/8.jpg"
                ...
                <div>
                    <div class="basic-product theme-product-11">
                        <div class="img-wrapper">
                            <a href="product-page(accordian).html"><img src="../assets/images/jewellery-1/product/9.jpg"
                                    class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            <div class="cart-info">
                                <a href="javascript:void(0)" title="Add to Wishlist">
                                    <i class="ri-heart-line"></i>
                ...
                <div>
                    <div class="basic-product theme-product-11">
                        ...
                        <div class="product-detail">
                            ...
                            <h4 class="price">$ 79.20<del> $80.00 </del><span class="discounted-price"> 5% Off </span>
                            </h4>
                            <div class="rating-w-count mb-0 mt-2">
                                <div class="rating"><i class="ri-star-fill"></i> <i class="ri-star-fill"></i> <i
                                        class="ri-star-fill"></i>
                        ...
                        <div class="abs-product">
                            <div class="product-detail mt-0">
                                ...
                                <h4 class="price">$ 79.20<del> $80.00 </del><span class="discounted-price"> 5% Off
                                    </span>
                                </h4>
                            </div>
                ...
                <div>
                    <div class="basic-product theme-product-11">
                        <div class="img-wrapper">
                            <a href="product-page(accordian).html"><img src="../assets/images/jewellery-1/product/1.jpg"
                                    class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            <div class="cart-info">
                                <a href="javascript:void(0)" title="Add to Wishlist">
                                    <i class="ri-heart-line"></i>
                        ...
                        <div class="product-detail">
                            ...
                            <h6> Classic Gold Bracelet </h6>
                            <h4 class="price">$ 78.90 </h4>
                            <div class="rating-w-count mb-0 mt-2">
                                <div class="rating"><i class="ri-star-fill"></i> <i class="ri-star-fill"></i> <i
                                        class="ri-star-fill"></i>
                                    <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
    ...
    <!-- Parallax banner -->
    <section class="p-0">
        <div class="text-center p-center">
            <img src="../assets/images/jewellery-2/full-banner/2.png" alt="" class="img-fluid blur-up lazyload">
    ...
    <section class="tools-service service-w-bg">
        <div class="container">
            ...
            <div class="row g-4 partition_3">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery-2/product-sm/1.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Leaves Sheep Rose Gold bracelet</h6>
                                        </a>
                                        <h4>$240.00</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery-2/product-sm/2.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Serpent Boheme Gold and Diamond Bracelet</h6>
                                        </a>
                                        <h4>$620.00</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery-2/product-sm/3.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Flower Sheep gold And Diamond Pendant</h6>
                                        </a>
                                        <h4>$220.00</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery-2/product-sm/5.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>platinum Bracelet With Diamond</h6>
                                        </a>
                                        <h4>$320.00</h4>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery-2/product-sm/4.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Star Sheep Gold Rings With Diamond</h6>
                                        </a>
                                        <h4>$280.80</h4>
                                    </div>
                                </div>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery-2/product-sm/6.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Golden Pearl Ringing Bracelet</h6>
                                        </a>
                                        <h4>$200.00 <del>$250.00</del></h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                ...
                <div class="col-lg-4 center-slider border-0">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="category-page.html">
                                <div class="collection-banner mb-2">
                                    <div class="img-part">
                                        <img src="../assets/images/jewellery-2/banner/6.png" alt=""
                        ...
                        <div class="col-md-12">
                            <a href="category-page.html">
                                <div class="collection-banner">
                                    <div class="img-part">
                                        <img src="../assets/images/jewellery-2/banner/7.png" alt=""
                                            class="img-fluid blur-up lazyload w-100">
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery-2/product-sm/7.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Rose Gold 18K Box Sheep Bracelet</h6>
                                        </a>
                                        <h4>$220.10</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery-2/product-sm/8.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Rose Gold Fiorever Bracelet</h6>
                                        </a>
                                        <h4>$260.50</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery-2/product-sm/9.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Lotus Blossom Diamond Ring</h6>
                                        </a>
                                        <h4>$280.60</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery-2/product-sm/11.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6> Three Row Diamond Rose Gold Bracelet</h6>
                                        </a>
                                        <h4>$400.00</h4>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery-2/product-sm/10.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Hook Disney Gold jewellery</h6>
                                        </a>
                                        <h4>$120.00</h4>
                                    </div>
                                </div>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery-2/product-sm/12.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Sightly Diamond Rose Gold Bracelet</h6>
                                        </a>
                                        <h4>$350.80 <del>$400.00</del></h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
    ...
    <section class="ratio_portrait bg-light section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="title6">
                ...
                <div class="col-12">
                    <div class="slide-4 category-m w-bg no-arrow">
                        <div>
                            <a href="category-page.html">
                                <div class="category-wrapper">
                                    <div>
                                        <h4 class="text-theme">For Couples</h4>
                                        ...
                                        <div>
                                            <img src="../assets/images/jewellery/category/1.png"
                        ...
                        <div>
                            <a href="category-page.html">
                                <div class="category-wrapper">
                                    <div>
                                        <h4 class="text-theme">for women</h4>
                                        <ul class="category-link">
                                        ...
                                        <div>
                                            <img src="../assets/images/jewellery/category/2.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div>
                            <a href="category-page.html">
                                <div class="category-wrapper">
                                    <div>
                                        <h4 class="text-theme">for men</h4>
                                        <ul class="category-link">
                                        ...
                                        <div>
                                            <img src="../assets/images/jewellery/category/3.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div>
                            <a href="category-page.html">
                                <div class="category-wrapper">
                                    <div>
                                        <h4 class="text-theme">for kids</h4>
                                        <ul class="category-link">
                                        ...
                                        <div>
                                            <img src="../assets/images/jewellery/category/4.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- timer banner start -->
    <section class="jewellery-banner">
        <div class="container">
            <div class="banner-timer mx-0">
                <img src="../assets/images/jewellery/timer-banner.html" class="img-fluid bg-img" alt="">
                <div class="row mx-0">
                    <div class="col-md-12">
                        <div class="banner-text">
                            <h2 class="text-start">Save <span>30% off</span> Digital Watch</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="bag-product ratio_square">
        <div class="container">
            <div class="tools-product-4 product-m no-arrow">
                <div>
                    <div class="basic-product theme-product-11">
                        <div class="img-wrapper">
                            <a href="product-page(accordian).html"><img src="../assets/images/jewellery-1/product/1.jpg"
                        ...
                        <div class="product-detail">
                            ...
                            <h4 class="price">$ 78.90 </h4>
                            <div class="rating-w-count mb-0 mt-2">
                                <div class="rating"><i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                ...
                <div>
                    <div class="basic-product theme-product-11">
                        <div class="img-wrapper">
                            <a href="product-page(accordian).html"><img src="../assets/images/jewellery-1/product/2.jpg"
                                    class="img-fluid blur-up lazyload" alt=""></a>
                            <div class="cart-info">
                                <a href="javascript:void(0)" title="Add to Wishlist">
                                    <i class="ri-heart-line"></i>
                        ...
                        <div class="product-detail">
                            ...
                            <h6> Diamond Ethereal Bracelet </h6>
                            <h4 class="price">$ 65.34</h4>
                            <div class="rating-w-count mb-0 mt-2">
                                <div class="rating"><i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                                    <i class="ri-star-fill"></i>
                                    <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                ...
                <div>
                    <div class="basic-product theme-product-11">
                        <div class="img-wrapper">
                            <a href="product-page(accordian).html"><img src="../assets/images/jewellery-1/product/3.jpg"
                                    class="img-fluid blur-up lazyload" alt=""></a>
                            <div class="cart-info">
                                <a href="javascript:void(0)" title="Add to Wishlist">
                                    <i class="ri-heart-line"></i>
                        ...
                        <div class="product-detail">
                            ...
                            <h6> Golden Floral Nosering </h6>
                            <h4 class="price">$ 90.20 </h4>
                            <div class="rating-w-count mb-0 mt-2">
                                <div class="rating"><i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                                    <i class="ri-star-fill"></i>
                                    <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                ...
                <div>
                    <div class="basic-product theme-product-11">
                        <div class="img-wrapper">
                            <a href="product-page(accordian).html"><img src="../assets/images/jewellery-1/product/4.jpg"
                                    class="img-fluid blur-up lazyload" alt=""></a>
                            <div class="cart-info">
                                <a href="javascript:void(0)" title="Add to Wishlist">
                                    <i class="ri-heart-line"></i>
                        ...
                        <div class="product-detail">
                            ...
                            <h6> Adjustable Gold Bracelet </h6>
                            <h4 class="price">$ 75.45<del> $82.00 </del><span class="discounted-price"> 7% Off
                                </span>
                            </h4>
                            <div class="rating-w-count mb-0 mt-2">
                                <div class="rating"><i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                        ...
                        <div class="abs-product">
                            <div class="product-detail mt-0">
                                ...
                                <h4 class="price">$ 75.45<del> $82.00 </del><span class="discounted-price"> 7%
                                        Off </span>
                                </h4>
                            </div>
                ...
                <div>
                    <div class="basic-product theme-product-11">
                        <div class="img-wrapper">
                            <a href="product-page(accordian).html"><img src="../assets/images/jewellery-1/product/5.jpg"
                                    class="img-fluid blur-up lazyload" alt=""></a>
                            <div class="cart-info">
                                <a href="javascript:void(0)" title="Add to Wishlist">
                                    <i class="ri-heart-line"></i>
                ...
                <div>
                    <div class="basic-product theme-product-11">
                        <div class="img-wrapper">
                            <a href="product-page(accordian).html"><img src="../assets/images/jewellery-1/product/7.jpg"
                                    class="img-fluid blur-up lazyload" alt=""></a>
                            <div class="cart-info">
                                <a href="javascript:void(0)" title="Add to Wishlist">
                                    <i class="ri-heart-line"></i>
                        ...
                        <div class="product-detail">
                            ...
                            <h6> Rose Gold Bracelet </h6>
                            <h4 class="price">$ 95.40 </h4>
                            <div class="rating-w-count mb-0 mt-2">
                                <div class="rating"><i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                                    <i class="ri-star-fill"></i>
                                    <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
