...
<li role="presentation" class="nav-item">
     <button class="nav-link" id="manage-sales-tab" data-bs-toggle="tab"
...
<li role="presentation" class="nav-item">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="faq-content tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="manage-sales-tab-pane" role="tabpanel">
                            <div class="row g-3">
                                <div class="col-12">
...
<a href="{{Route('deletesales',['id'=>$sale->id])}}"title="Change Status" id="{{$sale->id}}"class="delete_btn_ajax " data-toggle="tooltip"><span class="fas fa-trash" style="color:red;"></a><input type="hidden" class="delete_id_value" value='{{$sale->id}}'>


    <a href="{{Route('editsale',['id'=>$sale->id])}}"  title="Edit Details" data-toggle="tooltip">
        <span class="fa fa-pencil" style="color: yellow;"></span>
                            </a>

                            <a href="{{Route('readsale',['id'=>$sale->id])}}"  title="Edit Details" data-toggle="tooltip">
