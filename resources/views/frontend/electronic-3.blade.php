...
@section('main-container')      <!-- header end -->
    ...
    <section class="small-section small-slider pt-res-0">
        <div class="container">
            <div class="slider-animate home-slider">
                <div>
                    <div class="home">
                        <img src="../assets/images/electronics-3/full-banner/1.png" alt=""
                ...
                <div>
                    <div class="home">
                        <img src="../assets/images/electronics-3/full-banner/2.png" alt=""
                            class="bg-img blur-up lazyload">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="title-basic">
                        <h2 class="title"><i class="ri-flashlight-fill"></i> deals of the day</h2>
                        <div class="timer">
                            <p id="demo"></p>
                        </div>
                    </div>
                    <div class="product-5 product-m no-arrow">
                        ...
                        <div class="basic-product theme-product-5">
                            ...
                            <div class="product-detail">
                                ...
                                <h4 class="price">$ 150.00<del> $200.00 </del><span class="discounted-price"> 25%
                                        Off </span>
                                </h4>
                            </div>
                        </div>
                        ...
                        <div class="basic-product theme-product-5">
                            ...
                            <div class="product-detail">
                                ...
                                <h6> Macbook Pro</h6>
                                <h4 class="price">$ 150.50<del> $200.00 </del><span class="discounted-price"> 25%
                                        Off </span>
                                </h4>
                            </div>
                        </div>
                        ...
                        <div class="basic-product theme-product-5">
                            ...
                            <div class="product-detail">
                                ...
                                <h6>Sound in Air</h6>
                                <h4 class="price">$ 60.50<del> $75.00 </del><span class="discounted-price"> 20% Off
                                    </span>
                                </h4>
                            </div>
                        </div>
                        ...
                        <div class="basic-product theme-product-5">
                            ...
                            <div class="product-detail">
                                ...
                                <h4 class="price">$ 30.00<del> $40.00 </del><span class="discounted-price"> 10% Off
                                    </span>
                                </h4>
                            </div>
                        </div>
                        ...
                        <div class="basic-product theme-product-5">
                            ...
                            <div class="product-detail">
                                ...
                                <h4 class="price">$ 25.79<del> $30.00 </del><span class="discounted-price"> 5% Off
                                    </span>
                                </h4>
                            </div>
                        </div>
                        ...
                        <div class="basic-product theme-product-5">
                            ...
                            <div class="product-detail">
                                ...
                                <h4 class="price">$ 40.50<del> $50.00 </del><span class="discounted-price"> 5% Off
                                    </span>
                                </h4>
                            </div>
                        </div>
                        ...
                        <div class="basic-product theme-product-5">
                            ...
                            <div class="product-detail">
                                ...
                                <h4 class="price">$ 20.00<del> $25.00 </del><span class="discounted-price"> 5% Off
                                    </span>
                                </h4>
                            </div>
                        </div>
                        ...
                        <div class="basic-product theme-product-5">
                            ...
                            <div class="product-detail">
                                ...
                                <h6>Smart LED TV</h6>
                                <h4 class="price">$ 100.50<del> $125.00 </del><span class="discounted-price"> 15%
                                        Off </span>
                                </h4>
                            </div>
                        </div>
    ...
    <section class="banner-style-1 banner-section">
        <div class="full-box">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-7 card-margin">
                        <div class="banner-goggles banner-padding pt-0">
                            <a href="category-page.html" class="collection-banner">
                                <img src="../assets/images/electronics-3/banner/1.png"
                            ...
                            <div class="container p-0">
                                <div class="row">
                                    <div class="col-12 mb-4">
                                        <a href="category-page.html" class="collection-banner">
                                            <img src="../assets/images/electronics-3/banner/2.png"
                                                class="img-fluid blur-up lazyload w-100" alt="">
                                        </a>
                                    </div>
                                    <div class="col-12">
                                        <a href="category-page.html" class="collection-banner">
                                            <img src="../assets/images/electronics-3/banner/3.png"
                                                class="img-fluid blur-up lazyload w-100" alt="">
                    ...
                    <div class="col-lg-3 col-12 d-lg-block d-none">
                        <div class="banner-goggles banner-padding pt-0">
                            <a href="category-page.html" class="collection-banner">
                                <img src="../assets/images/electronics-3/banner/4.png"
                                    class="img-fluid blur-up lazyload w-100" alt="">
                            </a>
                        </div>
                    </div>
                            ...
                            <div>
                                <div class="basic-product theme-product-5">
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <h6>Apple Mac Mini</h6>
                                        <h4 class="price">$ 150.00<del> $200.00 </del><span class="discounted-price">
                                                25%
                                                Off </span>
                                        </h4>
                                    </div>
                            ...
                            <div>
                                <div class="basic-product theme-product-5">
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <h6> Macbook Pro</h6>
                                        <h4 class="price">$ 150.50<del> $200.00 </del><span class="discounted-price">
                                                25%
                                                Off </span>
                                        </h4>
                                    </div>
                            ...
                            <div>
                                <div class="basic-product theme-product-5">
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <h6>Sound in Air</h6>
                                        <h4 class="price">$ 60.50<del> $75.00 </del><span class="discounted-price"> 20%
                                                Off </span>
                                        </h4>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="basic-product theme-product-5">
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <h6>Playstation Controller</h6>
                                        <h4 class="price">$ 30.00<del> $40.00 </del><span class="discounted-price"> 10%
                                                Off </span>
                                        </h4>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="basic-product theme-product-5">
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <h6>Digital Smart Watch</h6>
                                        <h4 class="price">$ 25.79<del> $30.00 </del><span class="discounted-price"> 5%
                                                Off </span>
                                        </h4>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="basic-product theme-product-5">
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <h6>Eve Outdoor Cam</h6>
                                        <h4 class="price">$ 40.50<del> $50.00 </del><span class="discounted-price"> 5%
                                                Off </span>
                                        </h4>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="basic-product theme-product-5">
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <h6>Klighten LED Lamp</h6>
                                        <h4 class="price">$ 20.00<del> $25.00 </del><span class="discounted-price"> 5%
                                                Off </span>
                                        </h4>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="basic-product theme-product-5">
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <h6>Smart LED TV</h6>
                                        <h4 class="price">$ 100.50<del> $125.00 </del><span class="discounted-price">
                                                15% Off </span>
                                        </h4>
                                    </div>
                                </div>
    ...
    <section class="container banner-section">
        <a href="category-page.html" class="small-banner">
            <img src="../assets/images/electronics-3/full-banner/3.png" alt="" class="img-fluid blur-up lazyload w-100">
        </a>
    </section>
    <!-- banner section end -->
    ...
    <!-- collection banner -->
    <section class="ratio2_1 banner-padding banner-section">
        <div class="container">
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="category-page.html" class="collection-banner">
                        <img src="../assets/images/electronics-3/banner/5.png" class="img-fluid blur-up lazyload w-100"
                            alt="">
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="category-page.html" class="collection-banner">
                        <img src="../assets/images/electronics-3/banner/6.png" class="img-fluid blur-up lazyload w-100"
                            alt="">
                    </a>
                </div>
            </div>
                    ...
                    <div class="theme-tab">
                        ...
                        <div class="tab-content-cls">
                            ...
                            <div id="tab-5" class="tab-content">
                                <div class="g-3 g-md-4 row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-lg-5">
                                    <div>
                                        <div class="basic-product theme-product-5">
                                            <div class="img-wrapper">
                                                <a href="category-page(no-sidebar).html"><img
