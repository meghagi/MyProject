    ...
    <section class="p-0">
        <a href="category-page.html">
            <img src="../assets/images/bags/full-banner/1.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- Home slider end -->
                ...
                <div class="col">
                    <div class="theme-tab">
                        <ul class="tabs tab-title">
                            <li class="current"><a href="tab-1.html"> Backpacks</a></li>
                            <li><a href="tab-2.html">Handbags</a></li>
                            <li><a href="tab-3.html">Satchels</a></li>
                        </ul>
                            ...
                            <div id="tab-1" class="tab-content active default">
                                <div class="product-4 product-m no-arrow">
                                    <div class="basic-product theme-product-5">
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/bags/product/1.jpg"
                                    ...
                                    <div class="basic-product theme-product-5">
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/bags/product/4.jpg"
                                                    class="img-fluid blur-up lazyload" alt=""></a>
                                            <div class="cart-info">
                                                <button onclick="openCart()" title="Add to cart">
                                                    <i class="ri-shopping-cart-line"></i>
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <h6> Faguo Black Backpack </h6>
                                            <h4 class="price">
                                                $ 15.67<del> $18.40 </del><span class="discounted-price"> 6% Off </span>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="tab-2" class="tab-content">
                                <div class="product-4 product-m no-arrow">
                                    <div class="basic-product theme-product-5">
                                        <div class="img-wrapper">
                                            <a href="#!">
                                                <img src="../assets/images/bags/product/5.jpg"
                                    ...
                                    <div class="basic-product theme-product-5">
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/bags/product/6.jpg"
                                                    class="img-fluid blur-up lazyload" alt=""></a>
                                            <div class="cart-info">
                                                <button onclick="openCart()" title="Add to cart">
                                                    <i class="ri-shopping-cart-line"></i>
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <h6>Parker Backpack </h6>
                                            <h4 class="price">
                                                $ 12.76<del> $14.00 </del><span class="discounted-price"> 9% Off </span>
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="basic-product theme-product-5">
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/bags/product/7.jpg"
                                                    class="img-fluid blur-up lazyload" alt=""></a>
                                            <div class="cart-info">
                                                <button onclick="openCart()" title="Add to cart">
                                                    <i class="ri-shopping-cart-line"></i>
                                    ...
                                    <div class="basic-product theme-product-5">
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/bags/product/8.jpg"
                                                    class="img-fluid blur-up lazyload" alt=""></a>
                                            <div class="cart-info">
                                                <button onclick="openCart()" title="Add to cart">
                                                    <i class="ri-shopping-cart-line"></i>
                            ...
                            <div id="tab-3" class="tab-content">
                                <div class="product-4 product-m no-arrow">
                                    <div class="basic-product theme-product-5">
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/bags/product/9.jpg"
                                                    class="img-fluid blur-up lazyload" alt=""></a>
                                            <div class="cart-info">
                                                <button onclick="openCart()" title="Add to cart">
                                                    <i class="ri-shopping-cart-line"></i>
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <h6> Ranboo Crossbody Bag </h6>
                                            <h4 class="price">
                                                $ 14.25<del> $15.80 </del><span class="discounted-price"> 6% Off </span>
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="basic-product theme-product-5">
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/bags/product/5.jpg"
                                                    class="img-fluid blur-up lazyload" alt=""></a>
                                            <div class="cart-info">
                                                <button onclick="openCart()" title="Add to cart">
                                                    <i class="ri-shopping-cart-line"></i>
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <h6> Williamson Satchel Bag </h6>
                                            <h4 class="price">
                                                $ 18.60<del> $20.40 </del><span class="discounted-price"> 10% Off
                                                </span>
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="basic-product theme-product-5">
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/bags/product/11.jpg"
                                                    class="img-fluid blur-up lazyload" alt=""></a>
                                            <div class="cart-info">
                                                <button onclick="openCart()" title="Add to cart">
                                                    <i class="ri-shopping-cart-line"></i>
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <h6> Fawn Mini Backpack </h6>
                                            <h4 class="price">
                                                $ 9.22<del> $13.67 </del><span class="discounted-price"> 5% Off </span>
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="basic-product theme-product-5">
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/bags/product/12.jpg"
                                                    class="img-fluid blur-up lazyload" alt=""></a>
                                            <div class="cart-info">
                                                <button onclick="openCart()" title="Add to cart">
                                                    <i class="ri-shopping-cart-line"></i>
    ...
    <section class="p-0">
        <a href="category-page.html">
            <img src="../assets/images/bags/full-banner/2.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- parallax banner end -->
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            ...
                                            src="../assets/images/bags/product-sm/1.jpg"></a>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/bags/product-sm/2.jpg"></a>
                                    <div class="media-body align-self-center mt-0">
                                        <div class="rating">
                                            <i class="ri-star-fill"></i>
                                            <i class="ri-star-fill"></i>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/bags/product-sm/3.jpg"></a>
                                    <div class="media-body align-self-center mt-0">
                                        <div class="rating">
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/bags/product-sm/4.jpg"></a>
                                    <div class="media-body align-self-center mt-0">
                                        <div class="rating">
                                            <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                                            <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                            ...
                            <div>
                                <div class="basic-product theme-product-5">
                                    <div class="img-wrapper">
                                        <a href="product-page(accordian).html"><img
                                                src="../assets/images/bags/product/1.jpg"
                                                class="img-fluid blur-up lazyload m-auto" alt=""></a>
                                        <div class="cart-info">
                                            <button onclick="openCart()" title="Add to cart">
                                                <i class="ri-shopping-cart-line"></i>
                                            </button>
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <h4 class="price">
                                            $ 2.79<del> $3.00 </del><span class="discounted-price"> 7% Off </span>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="basic-product theme-product-5">
                                    <div class="img-wrapper">
                                        <a href="product-page(accordian).html">
                                            <img src="../assets/images/bags/product/5.jpg"
                                                class="img-fluid blur-up lazyload m-auto" alt="">
                                        </a>
                                        <div class="cart-info">
                                            <button onclick="openCart()" title="Add to cart">
                                                <i class="ri-shopping-cart-line"></i>
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/bags/product-sm/5.jpg"></a>
                                    <div class="media-body align-self-center mt-0">
                                        <div class="rating">
                                            <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                                            <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/bags/product-sm/6.jpg"></a>
                                    <div class="media-body align-self-center mt-0">
                                        <div class="rating">
                                            <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                                            <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/bags/product-sm/7.jpg"></a>
                                    <div class="media-body align-self-center mt-0">
                                        <div class="rating">
                                            <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                                            <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/bags/product-sm/8.jpg"></a>
                                    <div class="media-body align-self-center mt-0">
                                        <div class="rating">
                                            <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                                            <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
            ...
            <div class="row order-section">
                <div class="col-sm-4 p-0">
                    <a href="#!" class="image-block">
                        <img alt="" src="../assets/images/bags/banner/1.jpg" class="img-fluid blur-up lazyload bg-img">
                    </a>
                </div>
                <div class="col-sm-4 p-0">
                ...
                <div class="col-sm-4 p-0">
                    <a href="#!" class="image-block"><img alt="" src="../assets/images/bags/banner/2.jpg"
                ...
                <div class="col-sm-4 p-0">
                    <div class="contain-block">
                        <div>
                            ...
                            <a href="#!" class="btn btn-solid category-btn">save 30% off</a>
                            <a href="category-page.html">
                                <h6><span>shop now</span></h6>
                            </a>
                        </div>
                ...
                <div class="col-sm-4 p-0">
                    <a href="#!" class="image-block even"><img alt="" src="../assets/images/bags/banner/3.jpg"
                            class="img-fluid blur-up lazyload bg-img"></a>
                </div>
                <div class="col-sm-4 p-0">
                    <div class="contain-block">
                        <div>
                            ...
                            <a href="category-page.html" class="btn btn-solid category-btn">minimum 50% off</a>
                            <a href="category-page.html">
                                <h6><span>shop now</span></h6>
                            </a>
                        </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="product-4 product-m no-arrow">
                        <div class="basic-product theme-product-5">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/bags/product/1.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <button onclick="openCart()" title="Add to cart">
                                        <i class="ri-shopping-cart-line"></i>
                        ...
                        <div class="basic-product theme-product-5">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/bags/product/2.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <button onclick="openCart()" title="Add to cart">
                                        <i class="ri-shopping-cart-line"></i>
                        ...
                        <div class="basic-product theme-product-5">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/bags/product/3.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <button onclick="openCart()" title="Add to cart">
                                        <i class="ri-shopping-cart-line"></i>
                        ...
                        <div class="basic-product theme-product-5">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/bags/product/4.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <button onclick="openCart()" title="Add to cart">
                                        <i class="ri-shopping-cart-line"></i>
                        ...
                        <div class="basic-product theme-product-5">
                            <div class="img-wrapper">
                                <a href="#!">
                                    <img src="../assets/images/bags/product/5.jpg" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                                <div class="cart-info">
                                    <button onclick="openCart()" title="Add to cart">
                        ...
                        <div class="basic-product theme-product-5">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/bags/product/6.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <button onclick="openCart()" title="Add to cart">
                                        <i class="ri-shopping-cart-line"></i>
                        ...
                        <div class="basic-product theme-product-5">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/bags/product/7.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <button onclick="openCart()" title="Add to cart">
                                        <i class="ri-shopping-cart-line"></i>
                        ...
                        <div class="basic-product theme-product-5">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/bags/product/8.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <button onclick="openCart()" title="Add to cart">
                                        <i class="ri-shopping-cart-line"></i>
                        ...
                        <div class="basic-product theme-product-5">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/bags/product/9.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <button onclick="openCart()" title="Add to cart">
                                        <i class="ri-shopping-cart-line"></i>
                        ...
                        <div class="basic-product theme-product-5">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/bags/product/5.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <button onclick="openCart()" title="Add to cart">
                                        <i class="ri-shopping-cart-line"></i>
                        ...
                        <div class="basic-product theme-product-5">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/bags/product/11.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <button onclick="openCart()" title="Add to cart">
                                        <i class="ri-shopping-cart-line"></i>
                        ...
                        <div class="basic-product theme-product-5">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img src="../assets/images/bags/product/12.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <button onclick="openCart()" title="Add to cart">
                                        <i class="ri-shopping-cart-line"></i>
    ...
    <!-- blog section -->
    <section class="blog ratio3_2 slick-default-margin">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="title2">
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/bags/blog/1.png"
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/bags/blog/2.png"
                                            class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/bags/blog/3.png"
                                            class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
                ...
                <div class="col-md-12 p-0">
                    ...
                    <div class="slide-7 no-arrow slick-instagram">
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img alt="" src="../assets/images/slider/bags/1.jpg" class="bg-img"
                                        style="width: 100%">
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img alt="" src="../assets/images/slider/bags/2.jpg" class="bg-img"
                                        style="width: 100%">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img alt="" src="../assets/images/slider/bags/3.jpg" class="bg-img"
                                        style="width: 100%">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img alt="" src="../assets/images/slider/bags/4.jpg" class="bg-img"
                                        style="width: 100%">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img alt="" src="../assets/images/slider/bags/5.jpg" class="bg-img"
                                        style="width: 100%">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img alt="" src="../assets/images/slider/bags/6.jpg" class="bg-img"
                                        style="width: 100%">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img alt="" src="../assets/images/slider/bags/7.jpg" class="bg-img"
                                        style="width: 100%">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img alt="" src="../assets/images/slider/bags/8.jpg" class="bg-img"
                                        style="width: 100%">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
