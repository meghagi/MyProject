                    ...
                    <div class="tab-content nav-material" id="top-tabContent">
                        <div class="tab-pane fade show active" id="top-home" role="tabpanel"
                            ...
                            <div class="product-tab-description">
                                <div class="part">
                                    <p>"Gym Coords Set" offers a comprehensive solution for those seeking comfort and
                                        style in their workout attire. This coordinated set is meticulously designed to
                                        elevate your gym experience, blending functionality with fashion seamlessly.
                                        Crafted from high-quality, breathable fabrics, each piece in the set ensures
                                        optimal performance and comfort during your exercise routines.</p>
                                    <p>The set includes everything you need for a complete workout ensemble, featuring
                                        coordinating tops, bottoms, and accessories. Whether you're hitting the
                                        treadmill, pumping iron, or attending a yoga class, the Gym Coords Set has you
                                        covered in both style and functionality.</p>
                                    <p>With its modern design and versatile color palette, this set transitions
                                        effortlessly from the gym to casual outings, making it a practical addition to
                                        any active lifestyle. Embrace the confidence and motivation that comes with
                                        looking and feeling your best during every workout session with the Gym Coords
                                        Set.</p>
                                </div>
                            </div>
                        </div>
