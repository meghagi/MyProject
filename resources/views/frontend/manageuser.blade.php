...
Manage Product
    ...
    <li role="presentation" class="nav-item">
     <button class="nav-link" id="manage-customer-tab" data-bs-toggle="tab"
...
Manage Sales
                                ...
                                <li role="presentation" class="nav-item">
                                    <button class="nav-link" id="manage-user-tab" data-bs-toggle="tab"
                                        data-bs-target="#manage-user-tab-pane" type="button" role="tab">
...
<li role="presentation" class="nav-item">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="faq-content tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="manage-user-tab-pane" role="tabpanel">
                            <div class="row g-3">
                                <div class="col-12">
...
<a href="{{Route('deleteusers',['id'=>$users->id])}}"title="Change Status" id="{{$users->id}}"class="delete_btn_ajax1 " data-toggle="tooltip"><span class="fas fa-trash" style="color:red;"></a><input type="hidden" class="delete_id_value" value='{{$users->id}}'>


    <a href="{{Route('edituser',['id'=>$users->id])}}"  title="Edit Details" data-toggle="tooltip">
        <span class="fa fa-pencil" style="color: yellow;"></span>
                            </a>
                            <a href="{{Route('readuser',['id'=>$users->id])}}"  title="Edit Details" data-toggle="tooltip">
