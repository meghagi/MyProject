    ...
    <section class="p-0 layout-7">
        <a href="category-page.html">
            <img src="../assets/images/marketplace-1/full-banner/1.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- Home slider end -->
    ...
    <!-- collection banner -->
    <section class="banner-padding banner-furniture ratio2_1 banner-section">
        <div class="container-fluid">
            <div class="row partition4">
                <div class="col-lg-3 col-md-6">
                    <a href="category-page.html" class="collection-banner">
                        <img src="../assets/images/marketplace-1/banner/1.png" class="img-fluid blur-up lazyload">
                    </a>
                </div>
                <div class="col-lg-3 col-md-6">
                    <a href="category-page.html" class="collection-banner">
                        <img src="../assets/images/marketplace-1/banner/2.png" class="img-fluid blur-up lazyload">
                    </a>
                </div>
                <div class="col-lg-3 col-md-6">
                    <a href="category-page.html" class="collection-banner">
                        <img src="../assets/images/marketplace-1/banner/3.png" class="img-fluid blur-up lazyload">
                    </a>
                </div>
                <div class="col-lg-3 col-md-6">
                    <a href="category-page.html" class="collection-banner">
                        <img src="../assets/images/marketplace-1/banner/4.png" class="img-fluid blur-up lazyload">
                    </a>
                </div>
            </div>
        </div>
                ...
                <div>
                    <div class="basic-product theme-product-6">
                        ...
                        <div class="product-detail">
                            ...
                            <h4 class="price">$ 10.00<del> $12.00 </del><span class="discounted-price"> 10% Off </span>
                            </h4>
                            <div class="addtocart_btn">
                                <button class="add-button add_cart" title="Add to cart">
                                    Add to Cart
    ...
    <section class="p-0">
        <a href="category-page.html">
            <img src="../assets/images/marketplace-1/full-banner/2.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- full banner end -->
            ...
            <div class="row multiple-slider">
                <div class="col-xl-4 col-lg-4 col-md-12">
                    <div class="theme-card">
                        <h5 class="title-border"> Free delivery</h5>
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace-1/product-sm/1.jpg" alt=""></a>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace-1/product-sm/2.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace-1/product-sm/3.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace-1/product-sm/4.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                ...
                <div class="col-xl-8 col-lg-8 col-md-12">
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-6">
                                            ...
                                            <div class="product-detail">
                                                ...
                                                <h4 class="price">$ 8.79<del> $10.00 </del><span
                                                        class="discounted-price"> 6% Off </span>
                                                </h4>
                                                <div class="addtocart_btn">
                                                    <button class="add-button add_cart" title="Add to cart">
                                                        Add to Cart
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-6">
                                            ...
                                            <div class="product-detail">
                                                ...
                                                <h4 class="price">$ 2.50<del> $3.00 </del><span
                    ...
                    <a href="category-page.html" class="banner-tools d-block">
                        <img src="../assets/images/marketplace-1/banner/5.png" alt="" class="img-fluid w-100">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12 p-0">
                    ...
                    <div class="slide-7 no-arrow slick-instagram">
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="../assets/images/marketplace-1/instagram/1.png"
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="../assets/images/marketplace-1/instagram/2.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="../assets/images/marketplace-1/instagram/3.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="../assets/images/marketplace-1/instagram/4.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="../assets/images/marketplace-1/instagram/5.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="../assets/images/marketplace-1/instagram/6.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
