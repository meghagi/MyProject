  ...
  @section('main-container')  
    ...
    <section class="p-0">
        ...
        <a href="category-page.html" class="home">
            <img src="../assets/images/beauty/full-banner/1.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- Home slider end -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-6 col-md-12 offset-xl-1 text-center"><img
                        src="../assets/images/beauty/banner/1.png" alt="" class="img-fluid blur-up lazyload">
                </div>
                                ...
                                <div class="overflow-hidden">
                                    ...
                                    <div class="img-wrapper">
                                        <a href="product-page(accordian).html"><img
                                                src="../assets/images/beauty/product/1.jpg"
                                    ...
                                    <div class="product-detail">
                                        <div>
                                            ...
                                            <h4 class="price mt-2">$ 14.79<del> $17.00 </del>
                                            </h4>
                                        </div>
                        ...
                        <div>
                            <div class="basic-product theme-product-1">
                                <div class="overflow-hidden">
                                    ...
                                    <div class="img-wrapper">
                                        <a href="product-page(accordian).html"><img
                                                src="../assets/images/beauty/product/2.jpg"
                                                class="img-fluid blur-up lazyload " alt=""></a>
                                        <div class="rating-label"><i class="fa fa-star"></i>
                                            <span>4.5</span>
                                        </div>
                                    ...
                                    <div class="product-detail">
                                        <div>
                                            <div class="brand-w-color">
                                                <a class="product-title product-title1"
                                                    href="product-page(accordian).html">
                                                    Powder Perfection Compact </a>
                                            </div>
                                            <h4 class="price mt-2">$ 8.79<del> $10.00 </del> </h4>
                                        </div>
                                        <ul class="offer-panel">
                                            <li><span class="offer-icon"><i class="ri-discount-percent-fill"></i></span>
                                                Limited Time Offer: 5% off</li>
                        ...
                        <div>
                            <div class="basic-product theme-product-1">
                                <div class="overflow-hidden">
                                    ...
                                    <div class="img-wrapper">
                                        <a href="product-page(accordian).html"><img
                                                src="../assets/images/beauty/product/3.jpg"
                                                class="img-fluid blur-up lazyload " alt=""></a>
                                        <div class="rating-label"><i class="fa fa-star"></i>
                                            <span>4.5</span>
                                        </div>
                                    ...
                                    <div class="product-detail">
                                        <div>
                                            ...
                                            <h4 class="price mt-2">$ 16.79<del> $19.00 </del>
                                            </h4>
                                        </div>
                                        <ul class="offer-panel">
                                            <li><span class="offer-icon"><i class="ri-discount-percent-fill"></i></span>
                        ...
                        <div>
                            <div class="basic-product theme-product-1">
                                <div class="overflow-hidden">
                                    ...
                                    <div class="img-wrapper">
                                        <a href="product-page(accordian).html"><img
                                                src="../assets/images/beauty/product/4.jpg"
                                                class="img-fluid blur-up lazyload " alt=""></a>
                                        <div class="rating-label"><i class="fa fa-star"></i>
                                            <span>4.5</span>
                                        </div>
                                    ...
                                    <div class="product-detail">
                                        <div>
                                            <div class="brand-w-color">
                                                <a class="product-title product-title1"
                                                    href="product-page(accordian).html">
                                                    Velvet Glow Powder </a>
                                            </div>
                                            <h4 class="price mt-2">$ 12.79<del> $16.00 </del><span
                        ...
                        <div>
                            <div class="basic-product theme-product-1">
                                <div class="overflow-hidden">
                                    ...
                                    <div class="img-wrapper">
                                        <a href="product-page(accordian).html"><img
                                                src="../assets/images/beauty/product/5.jpg"
                                                class="img-fluid blur-up lazyload " alt=""></a>
                                        <div class="rating-label"><i class="fa fa-star"></i>
                                            <span>4.5</span>
                                        </div>
                                    ...
                                    <div class="product-detail">
                                        <div>
                                            <div class="brand-w-color">
                                                <a class="product-title product-title1"
                                                    href="product-page(accordian).html">
                                                    Radiance Boost Serum </a>

                                            </div>
                                            <h4 class="price mt-2">$ 20.60<del> $22.00 </del>
                                            </h4>
                                        </div>
                                        <ul class="offer-panel">
                                            <li><span class="offer-icon"><i class="ri-discount-percent-fill"></i></span>
                        ...
                        <div>
                            <div class="basic-product theme-product-1">
                                <div class="overflow-hidden">
                                    ...
                                    <div class="img-wrapper">
                                        <a href="product-page(accordian).html"><img
                                                src="../assets/images/beauty/product/6.jpg"
                                                class="img-fluid blur-up lazyload " alt=""></a>
                                        <div class="rating-label"><i class="fa fa-star"></i>
                                            <span>4.5</span>
                                        </div>
                                    ...
                                    <div class="product-detail">
                                        <div>
                                            ...
                                            <h4 class="price mt-2">$ 10.60<del> $12.00 </del>
                                            </h4>
                                        </div>
                                        <ul class="offer-panel">
                                            <li><span class="offer-icon"><i class="ri-discount-percent-fill"></i></span>
                        ...
                        <div>
                            <div class="basic-product theme-product-1">
                                <div class="overflow-hidden">
                                    ...
                                    <div class="img-wrapper">
                                        <a href="product-page(accordian).html"><img
                                                src="../assets/images/beauty/product/7.jpg"
                                                class="img-fluid blur-up lazyload " alt=""></a>
                                        <div class="rating-label"><i class="fa fa-star"></i>
                                            <span>4.5</span>
                                        </div>
                                    ...
                                    <div class="product-detail">
                                        <div>
                                            <div class="brand-w-color">
                                                <a class="product-title product-title1"
                                                    href="product-page(accordian).html">
                                                    Silken Skin Secret </a>

                                            </div>
                                            <h4 class="price mt-2">$ 8.20<del> $10.00 </del>
                                            </h4>
                                        </div>
                                        <ul class="offer-panel">
                                            <li><span class="offer-icon"><i class="ri-discount-percent-fill"></i></span>
            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#video">
                        <div class="video-img"><img src="../assets/images/beauty/banner/2.png" alt=""
                                class="img-fluid blur-up lazyload">
                            <div class="play-btn"><span><i class="fa fa-play"></i></span></div>
                        </div>
                    </a>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <video controls class="video-cls">
                                        <source src="https://themes.pixelstrap.com/multikart/assets/images/beauty/video_1.mp4" type="video/mp4">
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/beauty/blog/1.png"
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/beauty/blog/2.png"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/beauty/blog/3.png"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/beauty/blog/4.png"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="slide-7 no-arrow slick-instagram">
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/beauty/instagram/1.png" alt="Avatar" class="bg-img"
                                        style="width:100%">
                                    <div class="overlay">
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/beauty/instagram/2.png" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/beauty/instagram/3.png" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/beauty/instagram/4.png" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/beauty/instagram/5.png" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/beauty/instagram/6.png" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/beauty/instagram/7.png" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/beauty/instagram/1.png" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
