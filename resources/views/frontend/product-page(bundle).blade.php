                    ...
                    <div class="row g-3">
                        <div class="col-xl-4 col-12">
                            <div class="sticky-details">
                                <div class="product-slick">
                                    <div><img src="../assets/images/product-details/product/23.jpg" alt=""
                                            class="w-100 img-fluid blur-up lazyload"></div>
                                    <div><img src="../assets/images/product-details/product/24.jpg" alt=""
                                            class="w-100 img-fluid blur-up lazyload"></div>
                                    <div><img src="../assets/images/product-details/product/25.jpg" alt=""
                                            class="w-100 img-fluid blur-up lazyload"></div>
                                    <div><img src="../assets/images/product-details/product/24.jpg" alt=""
                                            class="w-100 img-fluid blur-up lazyload"></div>
                                </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="product-page-details product-description-box sticky-details">
                                ...
                                <h2 class="main-title"> IPhone 14 Pro Max </h2>
                                ...
                                <div class="bordered-box p-0 border-0">
                                    ...
                                    <ul class="shipping-info">
                                        <li><span>SKU:</span> FAS18
                                        </li>
                                        <li><span>Unit:</span> 1 Item
                                        </li>
                                        <li><span>Weight:</span> 140
                                            Gms</li>
                                ...
                                <div class="dashed-border-box mb-0">
                                    <h4 class="sub-title">Guaranteed Safe Checkout</h4><img
                                        class="img-fluid payment-img" alt=""
                                        src="../assets/images/product-details/payments.png">
                                </div>

                                <div class="dashed-border-box mb-0">
                                    <h4 class="sub-title">Secure Checkout
                                    </h4>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="product-page-details product-form-box product-right-box d-flex
                                ...
                                <div class="border-product">
                                    <h4 class="sub-title">Frequently Bought Together</h4>
                                    <div class="bundle">
                                        <div class="bundle-image-box row g-3">
                                            <div class="col-xxl-6 col-xl-12 col-md-12 col-sm-6 col-12">
                                                <div class="bundle-box">
                                                    <div class="form-check"><input type="checkbox"
                                                            class="form-check-input checkbox_animated" id="crosssell-88"
                                                            value="88"></div>
                                                    <div class="bundle-image"><a href="#!"><img class="img-fluid"
                                                                src="../assets/images/product-details/product/38.jpg"
                                                                alt="Sonic Headphones"></a></div>
                                                    <div class="bundle-content">
                                                        <div>
                                                            <a href="#!">
                                                                <h4>Sonic Headphones</h4>
                                                            </a>
                                                        </div>
                                                        <h3>$24.48</h3>
                                                    </div>
                                            ...
                                            <div class="col-xxl-6 col-xl-12 col-md-12 col-sm-6 col-12">
                                                <div class="bundle-box">
                                                    <div class="form-check"><input type="checkbox"
                                                            class="form-check-input checkbox_animated" id="crosssell-86"
                                                            value="86"></div>
                                                    <div class="bundle-image"><a href="#!"><img class="img-fluid"
                                                                src="../assets/images/product-details/product/39.jpg"
                                                                alt="Magic Mouse"></a></div>
                                                    <div class="bundle-content">
                                                        <div>
                                                            <a href="#!">
                                                                <h4>Magic Mouse </h4>
                                            ...
                                            <div class="col-xxl-6 col-xl-12 col-sm-6 col-12">
                                                <div class="bundle-box">
                                                    <div class="form-check"><input type="checkbox"
                                                            class="form-check-input checkbox_animated" id="crosssell-83"
                                                            value="83"></div>
                                                    <div class="bundle-image">
                                                        <a href="#!">
                                                            <img class="img-fluid"
                                                                src="../assets/images/product-details/product/40.jpg"
                                                                alt="Sonos Speaker">
                                                        </a>
                                                    </div>
                                                    <div class="bundle-content">
                                        ...
                                        <h5 class="bundle-title">Product Selected For</h5>
                                        <h4 class="theme-color total-price">$215.43 </h4>

                                        <button class="btn btn-solid bundle-btn mt-0 mt-sm-2" id="addcartAllbtn"
                                            type="submit"> Buy This Bundle
                                        </button>
                                    </div>
                                </div>
