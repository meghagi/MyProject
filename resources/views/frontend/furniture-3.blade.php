    ...
    <section class="p-0 height-100 sm-responsive">
        <a href="category-page.html" class="home-slider">
            <div class="home">
                <img src="../assets/images/furniture-3/full-banner/1.png" alt="" class="bg-img blur-up lazyload">
            </div>
        </a>
    </section>
    <!-- Home slider end -->
                        ...
                        <a href="category-page.html">
                            <div class="collection-banner p-right text-center">
                                ...
                                <div class="absolute-img">
                                    <img src="../assets/images/furniture-3/category/1.png" class="img-fluid" alt="">
                                </div>
                    ...
                    <div class="col-md-4">
                        <a href="category-page.html">
                            <div class="collection-banner p-right text-center">
                                ...
                                <div class="absolute-img">
                                    <img src="../assets/images/furniture-3/category/2.png" class="img-fluid" alt="">
                                </div>
                                <div class="contain-banner banner-3">
                                    <div>
                                        <h4>save 60%</h4>
                    ...
                    <div class="col-md-4">
                        <a href="category-page.html">
                            <div class="collection-banner p-right text-center">
                                ...
                                <div class="absolute-img">
                                    <img src="../assets/images/furniture-3/category/3.png" class="img-fluid" alt="">
                                </div>
                                <div class="contain-banner banner-3">
                                    <div>
                                        <h4>save 50%</h4>
            ...
            <div class="row dark-box partition-five">
                ...
                <div class="col">
                    <div class="basic-product theme-product-4">
                        <div class="img-wrapper">
                            <a href="product-page(accordian).html"><img
                                    src="../assets/images/furniture-3/product/18.png"
                                    class="img-fluid blur-up lazyload bg-img" alt=""></a>
    ...
    <div class="container category-button button-dark">
        <section class="section-b-space border-section">
            <div class="slide-6 no-arrow slick-default-margin">
                <div><a href="category-page.html" class="btn btn-outline btn-block"><img
                            src="https://themes.pixelstrap.com/multikart/assets/svg/furniture/sofa.svg" class="img-fluid" alt="">living</a></div>
                <div><a href="category-page.html" class="btn btn-outline btn-block"><img
                            src="https://themes.pixelstrap.com/multikart/assets/svg/furniture/kitchen.svg" class="img-fluid" alt="">kitchen</a></div>
                <div><a href="category-page.html" class="btn btn-outline btn-block"><img
                            src="https://themes.pixelstrap.com/multikart/assets/svg/furniture/bed.svg" class="img-fluid" alt="">bedroom</a></div>
                <div><a href="category-page.html" class="btn btn-outline btn-block"><img
                            src="https://themes.pixelstrap.com/multikart/assets/svg/furniture/washbasin.svg" class="img-fluid" alt="">bathroom</a></div>
                <div><a href="category-page.html" class="btn btn-outline btn-block"><img
                            src="https://themes.pixelstrap.com/multikart/assets/svg/furniture/office.svg" class="img-fluid" alt="">office</a></div>
                <div><a href="category-page.html" class="btn btn-outline btn-block"><img
                            src="https://themes.pixelstrap.com/multikart/assets/svg/furniture/hanger.svg" class="img-fluid" alt="">decor</a></div>
            </div>
        </section>
    </div>
        ...
        <div class="row">
            <div class="col-xl-3 d-xl-block d-none">
                <a href="category-page(modern).html">
                    <img src="../assets/images/furniture-3/banner/3.png" class="img-fluid h-100" alt="">
                </a>
            </div>
            <div class="col-xl-9">
                <!-- Product section -->
