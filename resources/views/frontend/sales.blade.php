...
<a href="{{url('/customer')}}"> <button class="nav-link" id="customer-tab" data-bs-toggle="tab"
                ...
                <div class="col-lg-9">
                    ...
                    <div class="faq-content tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="add-sales-tab-pane" role="tabpanel">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card mb-0 mt-0">
                                        <div class="card-body">
                                            ...
                                            <form   action="{{url('/salesstore')}}"name="myForm" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row mb-3 align-items-center">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="productname" class="form-control" name="product_name"
                                                ...
                                                <div class="form-group">
                                                    <label for="quantity"
                                                        class="form-label col-xxl-2 col-lg-12 col-md-3">quantity
                        </label>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9"><input type="text"
                                                ...
                                                <div class="form-group">
                                                    <label for="salesprice"
                                                        class="form-label col-xxl-2 col-lg-12 col-md-3">salesprice</label>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="saleprice" class="form-control" name="salesprice"
                                                ...
                                                <div class="form-group">
                                                    <label for="ifsc"
                                                        class="form-label col-xxl-2 col-lg-12 col-md-3">discount</label>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="ifsc" class="form-control" name="discount"
