    ...
    <!-- Home slider -->
    <section class="p-0">
        <a href="category-page.html" class="home text-center">
            <img src="../assets/images/shoes/full-banner/1.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- Home slider end -->
                    ...
                    <div class="slide-6 no-arrow">
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image"><img class="icon"
                                        src="../assets/images/shoes/category/1.png" alt="">
                                </div>
                            </a>
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                ...
                                <div class="category-image"><img class="icon"
                                        src="../assets/images/shoes/category/2.png" alt="">
                                </div>
                            </a>
                            <div class="category-details">
                                <a href="category-page.html">
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                ...
                                <div class="category-image"><img class="icon"
                                        src="../assets/images/shoes/category/3.png" alt="">
                                </div>
                            </a>
                            <div class="category-details">
                                <a href="category-page.html">
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                ...
                                <div class="category-image"><img class="icon"
                                        src="../assets/images/shoes/category/4.png" alt="">
                                </div>
                            </a>
                            <div class="category-details">
                                <a href="category-page.html">
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                ...
                                <div class="category-image"><img class="icon"
                                        src="../assets/images/shoes/category/5.png" alt="">
                                </div>
                            </a>
                            <div class="category-details">
                                <a href="category-page.html">
    ...
    <!-- collection banner -->
    <section class="section-b-space pt-0 ratio_40">
        <div class="container">
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="category-page.html">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="../assets/images/shoes/banner/1.png" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-6">
                    <a href="category-page.html">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="../assets/images/shoes/banner/2.png" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                        </div>
                    </a>
                    ...
                    <div class="product-4 product-m no-arrow">
                        <div>
                            <div class="basic-product theme-product-4">
                                <div class="img-wrapper">
                                    ...
                                    <div class="cart-info">
                                        <a href="javascript:void(0)" title="Add to Wishlist" class="wishlist-icon">
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$22.10 <del> $26.00 </del><span class="discounted-price"> 15 % Off
                                        </span>
                                    </h4>
                                </div>
                            </div>
                            ...
                            <div class="basic-product theme-product-4">
                                <div class="img-wrapper">
                                    <a href="product-page(accordian).html"><img
                                            src="../assets/images/shoes/product/2.jpg"
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$14.10 <del> $16.00 </del><span class="discounted-price"> 15 % Off
                                        </span>
                                    </h4>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="basic-product theme-product-4">
                                <div class="img-wrapper">
                                    <a href="product-page(accordian).html"><img
                                            src="../assets/images/shoes/product/3.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 30.40 <del> $36.00 </del><span class="discounted-price"> 15 %
                                            Off
                                        </span>
                                    </h4>
                                </div>
                        ...
                        <div>
                            <div class="basic-product theme-product-4">
                                <div class="img-wrapper">
                                    <a href="product-page(accordian).html"><img
                                            src="../assets/images/shoes/product/4.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 20.80 <del> $26.00 </del><span class="discounted-price"> 15 %
                                            Off
                                        </span>
                                    </h4>
                                </div>
                        ...
                        <div>
                            <div class="basic-product theme-product-4">
                                <div class="img-wrapper">
                                    <a href="product-page(accordian).html"><img
                                            src="../assets/images/shoes/product/5.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 26.95 <del> $30.00 </del><span class="discounted-price"> 5 % Off
                                        </span>
                                    </h4>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="basic-product theme-product-4">
                                <div class="img-wrapper">
                                    <a href="product-page(accordian).html"><img
                                            src="../assets/images/shoes/product/6.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 30.27 <del> $40.00 </del><span class="discounted-price"> 15 %
                                            Off
                                        </span>
                                    </h4>
                                </div>
                        ...
                        <div>
                            <div class="basic-product theme-product-4">
                                <div class="img-wrapper">
                                    <a href="product-page(accordian).html"><img
                                            src="../assets/images/shoes/product/7.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 32.24 <del> $34.00 </del><span class="discounted-price"> 7 % Off
                                        </span>
                                    </h4>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="basic-product theme-product-4">
                                <div class="img-wrapper">
                                    <a href="product-page(accordian).html"><img
                                            src="../assets/images/shoes/product/8.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 35.65 <del> $40.00 </del><span class="discounted-price"> 6 % Off
                                        </span>
                                    </h4>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/shoes/1.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Solid Black Sports Shoes</h6>
                                        </a>
                                        <h4>$110.00 <del>$120.00</del></h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/shoes/2.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Printed White Sports Shoes</h6>
                                        </a>
                                        <h4>$80.00</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/shoes/3.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Light Orange Sports Shoes</h6>
                                        </a>
                                        <h4>$150.00 <del>$160.00</del></h4>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/shoes/10.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/shoes/11.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Solid Pink Sports Shoes</h6>
                                        </a>
                                        <h4>$90.90</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/shoes/12.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                    ...
                    <div class="theme-card">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/shoes/4.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Solid Orange Shoes</h6>
                                        </a>
                                        <h4>$50.00</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/shoes/5.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Black Green Shoes</h6>
                                        </a>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/shoes/6.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Solid Yellow Shoes</h6>
                                        </a>
                                        <h4>$50.00</h4>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/shoes/7.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Purple Casual Shoes</h6>
                                        </a>
                                        <h4>$50.00</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/shoes/8.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Dotted Black Shoes</h6>
                                        </a>
                                        <h4>$30.00 <del>$400.00</del></h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/shoes/9.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Solid Black Shoes</h6>
                                        </a>
                ...
                <div class="col">
                    <div class="theme-tab">
                        <ul class="tabs tab-title2">
                            <li class="current"><a href="tab-1.html">Athletic Shoes</a></li>
                            <li><a href="tab-2.html">Sneakers</a></li>
                                ...
                                <div class="g-3 g-md-4 row row-cols-2 row-cols-md-3 row-cols-xl-4">
                                    <div>
                                        <div class="basic-product theme-product-4">
                                            <div class="img-wrapper">
                                                <a href="product-page(accordian).html"><img
                                                        src="../assets/images/shoes/product/1.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                            ...
                                            <div class="product-detail">
                                                ...
                                                <h4 class="price">$ 28.50 <del> $29.00 </del><span
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-4">
                                            ...
                                            <div class="product-detail">
                                                ...
                                                <h4 class="price">$ 24.50<del> $26.00 </del><span
                                                        class="discounted-price"> 15 % Off
                                                    </span>
                                                </h4>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-4">
                                            ...
                                            <div class="product-detail">
                                                ...
                                                <h4 class="price">$ 30.40 <del> $35.00 </del><span
                                                        class="discounted-price"> 15 % Off
                                                    </span>
                                                </h4>
                                            </div>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-4">
                                            ...
                                            <div class="product-detail">
                                                ...
                                                <h4 class="price">$ 20.80<del> $26.00 </del><span
                                                        class="discounted-price"> 15 % Off
                                                    </span>
                                                </h4>
                                            </div>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-4">
                                            ...
                                            <div class="product-detail">
                                                ...
                                                <h4 class="price">$ 26.95 <del> $30.00 </del><span
                                                        class="discounted-price"> 10 % Off
                                                    </span>
                                                </h4>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-4">
                                            ...
                                            <div class="product-detail">
                                                ...
                                                <h4 class="price">$ 30.27 <del> $50.00 </del><span
                                                        class="discounted-price"> 25 % Off
                                                    </span>
                                                </h4>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-4">
                                            ...
                                            <div class="product-detail">
                                                ...
                                                <h4 class="price">$ 32.24 <del> $40.00 </del><span
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-4">
                                            ...
                                            <div class="product-detail">
                                                ...
                                                <h4 class="price">$ 35.65<del> $40.00 </del><span
                                                        class="discounted-price"> 10 % Off
                                                    </span>
                                                </h4>
                                            </div>
                    ...
                    <div class="slide-3 no-arrow">
                        <div>
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/shoes/blog/1.png"
                        ...
                        <div>
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/shoes/blog/2.png"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div>
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/shoes/blog/3.png"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="slide-5 no-arrow slick-instagram">
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/shoes/instagram/1.png"
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/shoes/instagram/2.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/shoes/instagram/3.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/shoes/instagram/4.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/shoes/instagram/5.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
