    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="banner-section"><img src="../assets/images/about/vendor.jpg" class="img-fluid blur-up lazyload"
                    alt="">
        ...
        <div class="container">
            <div class="col">
                <div>
                    ...
                    <a href="index-2.html" class="btn btn-solid btn-sm">start selling</a>
                </div>
            </div>
        </div>
    </section>
