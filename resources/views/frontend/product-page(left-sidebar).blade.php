        ...
        <div class="container">
            ...
            <nav class="theme-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Sport Set</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="row g-sm-4">
                    <div class="col-lg-3 d-none d-lg-block">
                        <div class="sticky-details">
                            <div class="accordion details-sidebar-accordion" id="accordionPanelsStayOpenExample">
                                            ...
                                            <ul class="collection-listing">
                                                <li>
                                                    <div class="form-check">
                                                        <label class="form-check-label">Couture Edge</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="form-check">
                                                        <label class="form-check-label">Glamour Gaze</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="form-check">
                                                        <label class="form-check-label">Urban Chic</label>
                                                    </div>
                                                <li>
                                                    <div class="form-check">
                                                        <label class="form-check-label">VogueVista</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="form-check">
                                                        <label class="form-check-label">Velocity Vibe</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="form-check">
                                                        <label class="form-check-label">Nourish Naturally</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="form-check">
                                                        <label class="form-check-label">Blossom Barn</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="form-check">
                                                        <label class="form-check-label">Time Craft</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="form-check">
                                                        <label class="form-check-label">Wander Pack</label>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <ul class="media-list">
                                    <li class="media">
                                        <a href="product-page(accordian).html">
                                            <img alt="" class="img-fluid product-sm blur-up lazyload"
                                                src="../assets/images/product-details/product/31.jpg">
                                        </a>
                                        <div class="media-body">
                                            <div class="rating justify-content-unset">
                                    ...
                                    <li class="media">
                                        <a href="product-page(accordian).html">
                                            <img alt="" class="img-fluid product-sm blur-up lazyload"
                                                src="../assets/images/product-details/product/32.jpg">
                                        </a>
                                        <div class="media-body">
                                            <div class="rating justify-content-unset">
                                                <i class="ri-star-fill"></i>
                                    ...
                                    <li class="media">
                                        <a href="product-page(accordian).html">
                                            <img alt="" class="img-fluid product-sm blur-up lazyload"
                                                src="../assets/images/product-details/product/33.jpg">
                                        </a>
                                        <div class="media-body">
                                            <div class="rating justify-content-unset">
                                                <i class="ri-star-fill"></i>
                                    ...
                                    <li class="media">
                                        <a href="product-page(accordian).html">
                                            <img alt="" class="img-fluid product-sm blur-up lazyload"
                                                src="../assets/images/product-details/product/34.jpg">
                                        </a>
                                        <div class="media-body">
                                            <div class="rating justify-content-unset">
                                                <i class="ri-star-fill"></i>
                            ...
                            <div class="col-lg-6">
                                <div class="sticky-details">
                                    <div class="product-slick">
                                        <div><img src="../assets/images/product-details/product/26.jpg" alt=""
                                                class="img-fluid blur-up lazyload w-100"></div>
                                        <div><img src="../assets/images/product-details/product/27.jpg" alt=""
                                                class="img-fluid blur-up lazyload w-100"></div>
                                        <div><img src="../assets/images/product-details/product/28.jpg" alt=""
                                                class="img-fluid blur-up lazyload w-100"></div>
                                        <div><img src="../assets/images/product-details/product/27.jpg" alt=""
                                                class="img-fluid blur-up lazyload w-100"></div>
                                    </div>
                            ...
                            <div class="col-lg-6 rtl-text position-relative">
                                <div class="product-page-details">
                                    <div class="trending-text">
                                        <img src="../assets/images/product-details/trending.gif" class="img-fluid"
                                            alt="">
                                        <h5>Selling fast! 51 people have this in their carts.</h5>
                                    </div>
                                    <h2 class="main-title">Sport Set (Green)</h2>
                                    ...
                                    <p class="description-text">
                                        Wide leg shorts with lace-up detail and a concealed zip closure. These
                                        comfortable and stylish shorts are perfect for creating a casual yet
                                        polished look. Whether you're dressing up for a night out or keeping it
                                        relaxed for a daytime stroll, these shorts are versatile and chic. Pair
                                        them
                                        with a tucked-in blouse and heels for a sophisticated ensemble, or opt
                                        for a
                                        casual vibe with a simple tee and sneakers.
                                    </p>
                                    ...
                                    <div class="variation-box size-box mt-3">
                                        ...
                                        <ul class="image-box">
                                            <li class="active">
                                                <img src="../assets/images/product-details/product/26.jpg" alt="">
                                            </li>
                                            <li>
                                                <img src="../assets/images/product-details/product/29.jpg" alt="">
                                            </li>
                                            <li>
                                                <img src="../assets/images/product-details/product/30.jpg" alt="">
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div class="tab-content nav-material" id="top-tabContent">
                        <div class="tab-pane fade show active" id="top-home" role="tabpanel"
                            ...
                            <div class="product-tab-description">
                                <div class="part">
                                    <p>Introducing our Sport Set, the ultimate companion for your active lifestyle.
                                        Whether you're hitting the gym, going for a run, or practicing yoga, this set
                                        has you covered. Crafted with comfort and performance in mind, each piece is
                                        designed to enhance your workout experience.</p>
                                    <p>The Sport Set includes a breathable and moisture-wicking top to keep you cool and
                                        dry during intense workouts. The fitted leggings offer flexibility and support,
                                        allowing you to move freely with confidence. Additionally, the set features a
                                        lightweight jacket for added warmth and protection during outdoor activities.
                                    </p>
                                    <p>With its stylish design and high-quality materials, our Sport Set seamlessly
                                        transitions from the gym to the streets, keeping you looking and feeling your
                                        best. Say goodbye to wardrobe malfunctions and hello to maximum performance with
                                        our Sport Set. Whether you're a seasoned athlete or just starting your fitness
                                        journey, this set is sure to become your go-to choice for all your active
                                        endeavors.</p>
                                </div>
                            </div>
                        </div>
