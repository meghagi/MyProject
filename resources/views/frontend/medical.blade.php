    ...
    <section class="p-0 position-relative overflow-hidden">
        <a href="category-page.html" class="home">
            <img src="../assets/images/medical/full-banner/1.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- Home slider end -->
                    ...
                    <div class="slide-6 no-arrow">
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image"><img src="https://themes.pixelstrap.com/multikart/assets/svg/medical/mask.svg" alt=""></div>
                            </a>
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image"><img src="https://themes.pixelstrap.com/multikart/assets/svg/medical/sugar-blood-level.svg"
                                        alt=""></div>
                            </a>
                            <div class="category-details">
                                <a href="category-page.html">
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image"><img src="https://themes.pixelstrap.com/multikart/assets/svg/medical/eye-drops.svg" alt=""></div>
                            </a>
                            <div class="category-details">
                                <a href="category-page.html">
                                    <h5>eye care</h5>
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image"><img src="https://themes.pixelstrap.com/multikart/assets/svg/medical/diet.svg" alt=""></div>
                            </a>
                            <div class="category-details">
                                <a href="category-page.html">
                                    <h5>diet</h5>
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image"><img src="https://themes.pixelstrap.com/multikart/assets/svg/medical/holding-hands.svg" alt="">
                                </div>
                            </a>
                            <div class="category-details">
                                <a href="category-page.html">
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image"><img src="https://themes.pixelstrap.com/multikart/assets/svg/medical/cream.svg" alt=""></div>
                            </a>
                            <div class="category-details">
                                <a href="category-page.html">
                                    <h5>skin care</h5>
                        ...
                        <div class="category-block">
                            <a href="category-page.html">
                                <div class="category-image"><img src="https://themes.pixelstrap.com/multikart/assets/svg/medical/drugs.svg" alt=""></div>
                            </a>
                            <div class="category-details">
                                <a href="category-page.html">
                                    <h5>immunity</h5>
    ...
    <section class="section-b-space pt-0 ratio_square">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="theme-tab">
                        <ul class="tabs tab-title">
                            <li class="current">
                                <a href="tab-4.html">First Aid Supplies</a>
                            </li>
                            <li>
                                <a href="tab-5.html">Orthopedic Supports</a>
                            </li>
                        </ul>
                            ...
                            <div id="tab-4" class="tab-content active default">
                                <div class="g-3 g-md-4 row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                                    <div>
                                        <div class="basic-product theme-product-3">
                                            <div class="img-wrapper">
                                                ...
                                                <a href="#!"><img src="../assets/images/medical/product/1.png"
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-3">
                                            <div class="img-wrapper">
                                                <div class="ribbon-round">15%</div>
                                                <a href="#!"><img src="../assets/images/medical/product/4.png"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                                <div class="cart-info">
                                                    <ul class="hover-action">
                                                        <li>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-3">
                                            <div class="img-wrapper">
                                                <div class="ribbon-round">14%</div>
                                                <a href="#!"><img src="../assets/images/medical/product/5.png"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                                <div class="cart-info">
                                                    <ul class="hover-action">
                                                        <li>
                                            ...
                                            <div class="product-detail">
                                                <a class="product-title" href="product-page(accordian).html">
                                                    Capsule Convenience Redefined </a>
                                                <div class="rating-w-count">
                                                    <div class="rating"><i class="ri-star-fill"></i> <i
                                                            class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                                                        <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
                                                ...
                                                <h4 class="price">$ 8.90<del> $10.00 </del>
                                                </h4>
                                                <a href="cart.html" class="add-cart-btn">Add to cart</a>
                                            </div>
                                        </div>
                                ...
                                <div class="g-3 g-md-4 row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                                    <div>
                                        <div class="basic-product theme-product-3">
                                            <div class="img-wrapper">
                                                <div class="ribbon-round">15%</div>
                                                <a href="#!"><img src="../assets/images/medical/product/6.png"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                                <div class="cart-info">
                                                    <ul class="hover-action">
                                                        <li>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-3">
                                            <div class="img-wrapper">
                                                <div class="ribbon-round">18%</div>
                                                <a href="#!"><img src="../assets/images/medical/product/7.png"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                                <div class="cart-info">
                                                    <ul class="hover-action">
                                                        <li>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-3">
                                            <div class="img-wrapper">
                                                <div class="ribbon-round">20%</div>
                                                <a href="#!"><img src="../assets/images/medical/product/8.png"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                                <div class="cart-info">
                                                    <ul class="hover-action">
                                                        <li>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-3">
                                            <div class="img-wrapper">
                                                <div class="ribbon-round">23%</div>
                                                <a href="#!"><img src="../assets/images/medical/product/9.png"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                                <div class="cart-info">
                                                    <ul class="hover-action">
                                                        <li>
                                            ...
                                            <div class="product-detail">
                                                ...
                                                <h4 class="price">$ 12.60<del> $13.80 </del>
                                                </h4>
                                                <a href="cart.html" class="add-cart-btn">Add to cart</a>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-3">
                                            <div class="img-wrapper">
                                                <div class="ribbon-round">25%</div>
                                                <a href="#!"><img src="../assets/images/medical/product/10.png"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                                <div class="cart-info">
                                                    <ul class="hover-action">
                                                        <li>
                                            ...
                                            <div class="product-detail">
                                                ...
                                                <h4 class="price">$ 8.19<del> $10.40 </del>
                                                </h4>
                                                <a href="cart.html" class="add-cart-btn">Add to cart</a>
                                            </div>
                                        </div>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <a href="category-page.html">
                        <div class="collection-banner p-left text-start">
                            <div class="img-part">
                                <img src="../assets/images/medical/banner/1.png" alt=""
                ...
                <div class="col-md-6">
                    <a href="category-page.html">
                        <div class="collection-banner p-left text-start">
                            <div class="img-part">
                                <img src="../assets/images/medical/banner/2.png" alt=""
                                    class="img-fluid blur-up lazyload w-100">
                            </div>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <a href="category-page.html">
                        <div class="collection-banner p-left text-start">
                            <div class="img-part">
                                <img src="../assets/images/medical/banner/3.png" alt=""
                                    class="img-fluid blur-up lazyload w-100">
                            </div>
                ...
                <div class="col-md-4">
                    <a href="category-page.html">
                        <div class="collection-banner p-left text-start">
                            <div class="img-part">
                                <img src="../assets/images/medical/banner/4.png" alt=""
                                    class="img-fluid blur-up lazyload w-100">
                            </div>
                ...
                <div class="col-md-4">
                    <a href="category-page.html">
                        <div class="collection-banner p-left text-start">
                            <div class="img-part">
                                <img src="../assets/images/medical/banner/5.png" alt=""
                                    class="img-fluid blur-up lazyload w-100">
                            </div>
            ...
            <div class="row multiple-slider">
                <div class="col-lg-3 col-sm-6">
                    <a href="category-page.html" class="collection-banner">
                        <img src="../assets/images/medical/banner/6.png" class="img-fluid blur-up lazyload w-100 "
                            alt="">
                    </a>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="theme-card">
                        <h5 class="title-border pt-cls-slider">feature product</h5>
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/medical/product-sm/1.jpg" alt=""></a>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/medical/product-sm/2.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        ...
                                        <h4>$1.50 <del>$600.00</del></h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/medical/product-sm/3.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Multi Vitamin Tablate</h6>
                                        </a>
                                        <h4>$3.00</h4>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/medical/product-sm/4.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/medical/product-sm/5.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/medical/product-sm/6.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>black face shield </h6>
                                        </a>
                                        <h4>$2.00 <del>$2.50</del></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <a href="category-page.html" class="collection-banner">
                        <img src="../assets/images/medical/banner/7.png" class="img-fluid blur-up lazyload w-100"
                            alt="">
                    </a>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="theme-card">
                        <h5 class="title-border pt-cls-slider">on sell</h5>
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/medical/product-sm/7.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/medical/product-sm/8.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Vitamin C Teblate</h6>
                                        </a>
                                        <h4>$3.00</h4>
                                    </div>
                                </div>
    ...
    <!-- blog section -->
    <section class="blog ratio3_2 gym-blog pt-0 slick-default-margin">
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/medical/blog/1.png"
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/medical/blog/2.png"
                                            class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/medical/blog/3.png"
                                            class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
    ...
    <section class="tools-service service-w-bg section-b-space">
        <div class="container">
