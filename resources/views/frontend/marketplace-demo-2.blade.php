    ...
    <section class="pt-0">
        <a href="category-page.html" class="home">
            <img src="../assets/images/marketplace-2/full-banner/1.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- Home slider end -->
            ...
            <div class="row m-0">
                <div class="col-lg-3 col-sm-6 p-0">
                    <a href="category-page.html">
                        <img src="../assets/images/marketplace-2/banner/1.png"
                            class="img-fluid blur-up lazyload w-100 h-100">
                    </a>
                </div>
                <div class="col-lg-3 col-sm-6 p-0">
                    <a href="category-page.html">
                        <img src="../assets/images/marketplace-2/banner/2.png"
                            class="img-fluid blur-up lazyload w-100 h-100">
                    </a>
                </div>
                <div class="col-lg-3 col-sm-6 p-0">
                    <a href="category-page.html">
                        <img src="../assets/images/marketplace-2/banner/3.png"
                            class="img-fluid blur-up lazyload w-100 h-100">
                    </a>
                </div>
                <div class="col-lg-3 col-sm-6 p-0">
                    <a href="category-page.html">
                        <img src="../assets/images/marketplace-2/banner/4.png"
                            class="img-fluid blur-up lazyload w-100 h-100">
                    </a>
                </div>
            </div>
                ...
                <div>
                    <div class="basic-product theme-product-6">
                        ...
                        <div class="product-detail">
                            ...
                            <h4 class="price">$ 8.79<del> $10.00 </del><span class="discounted-price"> 6% Off </span>
                            </h4>
                ...
                <div>
                    <div class="basic-product theme-product-6">
                        <div class="img-wrapper">
                            <label class="unit-label">1 Item</label>
                            <a href="product-page(accordian).html"><img
                                    src="../assets/images/marketplace-1/product/2.jpg"
                                    class="img-fluid blur-up lazyload" alt=""></a>
                            <div class="cart-info">
                                <a href="#!" title="Add to Wishlist">
                                    <i class="ri-heart-line"></i>
                        ...
                        <div class="product-detail">
                            ...
                            <h4 class="price">$ 15.90<del> $18.00 </del> </h4>
                            <div class="addtocart_btn">
                                <button class="add-button add_cart" title="Add to cart">
                                    Add to Cart
                                </button>
                ...
                <div>
                    <div class="basic-product theme-product-6">
                        <div class="img-wrapper">
                            <label class="unit-label">1 Item</label>
                            <a href="product-page(accordian).html"><img
                                    src="../assets/images/marketplace-1/product/3.jpg"
                                    class="img-fluid blur-up lazyload" alt=""></a>
                            <div class="cart-info">
                                <a href="#!" title="Add to Wishlist">
                                    <i class="ri-heart-line"></i>
                        ...
                        <div class="product-detail">
                            ...
                            <h4 class="price">$ 2.50<del> $3.00 </del><span class="discounted-price"> 7% Off </span>
                            </h4>
                            <div class="addtocart_btn">
                                <button class="add-button add_cart" title="Add to cart">
                                    Add to Cart
                ...
                <div>
                    <div class="basic-product theme-product-6">
                        <div class="img-wrapper">
                            <label class="unit-label">1 Item</label>
                            <a href="product-page(accordian).html"><img
                                    src="../assets/images/marketplace-1/product/4.jpg"
                                    class="img-fluid blur-up lazyload" alt=""></a>
                            <div class="cart-info">
                                <a href="#!" title="Add to Wishlist">
                                    <i class="ri-heart-line"></i>
                ...
                <div>
                    <div class="basic-product theme-product-6">
                        <div class="img-wrapper">
                            <label class="unit-label">1 Item</label>
                            <a href="product-page(accordian).html"><img
                                    src="../assets/images/marketplace-1/product/5.jpg"
                                    class="img-fluid blur-up lazyload" alt=""></a>
                            <div class="cart-info">
                                <a href="#!" title="Add to Wishlist">
                                    <i class="ri-heart-line"></i>
                        ...
                        <div class="product-detail">
                            ...
                            <h4 class="price">$ 15.70<del> $18.00 </del></h4>
                            <div class="addtocart_btn">
                                <button class="add-button add_cart" title="Add to cart">
                                    Add to Cart
                                </button>
                                            ...
                                            <div class="media">
                                                <a href="product-page(accordian).html">
                                                    <img class="img-fluid blur-up lazyload"
                                                        src="../assets/images/marketplace-2/collection/1.png" alt="">
                                                </a>
                                    ...
                                    <div class="sec-1">
                                        <div class="product-box2">
                                            <div class="media">
                                                <a href="product-page(accordian).html">
                                                    <img class="img-fluid blur-up lazyload"
                                                        src="../assets/images/marketplace-2/collection/2.jpg" alt="">
                                                </a>
                                                <div class="media-body align-self-center">
                                                    <div class="rating"><i class="fa fa-star"></i> <i
                                                            class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                    ...
                                    <div class="sec-1">
                                        <div class="product-box2">
                                            <div class="media">
                                                <a href="product-page(accordian).html">
                                                    <img class="img-fluid blur-up lazyload"
                                                        src="../assets/images/marketplace-2/collection/3.jpg" alt="">
                                                </a>
                                                <div class="media-body align-self-center">
                                                    <div class="rating"><i class="fa fa-star"></i> <i
                                                            class="fa fa-star"></i> <i class="fa fa-star"></i> <i
            ...
            <div class="row">
                <div class="col-12">
                    <div class="title-basic">
                        <h2 class="title font-fraunces"><i class="ri-flashlight-fill"></i>Don't Miss These</h2>
                    </div>
                </div>
                <div class="col-12">
                    <div class="g-3 g-md-4 row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-2/product/6.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 20.30<del> $23.00 </del><span class="discounted-price"> 7% Off
                                        </span>
                                    </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-2/product/7.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 22.00<del> $24.00 </del><span class="discounted-price"> 10% Off
                                        </span>
                                    </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-2/product/8.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-2/product/9.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 16.40<del> $18.20 </del> </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
                                            Add to Cart
                                        </button>
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-2/product/10.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 15.50<del> $16.80 </del><span class="discounted-price"> 6% Off
                                        </span>
                                    </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
                ...
                <div class="col-12 section-t-space">
                    <div class="title-basic">
                        <h2 class="title font-fraunces"><i class="ri-flashlight-fill"></i> Trending Offers</h2>
                    </div>
                </div>
                <div class="col-12">
                    <div class="g-3 g-md-4 row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-2/product/11.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$12.80<del> $13.40 </del><span class="discounted-price"> 4% Off
                                        </span>
                                    </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-2/product/12.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-2/product/13.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 13.60<del> $14.50 </del> </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
                                            Add to Cart
                                        </button>
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-2/product/14.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 16.50<del> $18.00 </del><span class="discounted-price"> 13% Off
                                        </span>
                                    </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-2/product/15.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 15.20<del> $16.80 </del><span class="discounted-price"> 5% Off
                                        </span>
                                    </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
    ...
    <!-- two banner -->
    <section class="pb-0 ratio2_1 banner-section">
        <div class="container">
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="category-page.html" class="collection-banner">
                        <img src="../assets/images/marketplace-2/banner/5.png" class="img-fluid blur-up lazyload"
                            alt="">
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="category-page.html" class="collection-banner">
                        <img src="../assets/images/marketplace-2/banner/6.png" class="img-fluid blur-up lazyload"
                            alt="">
                    </a>
                </div>
            </div>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace-2/product-sm/1.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Goldan Digital Watch</h6>
                                        </a>
                                        <h4>$10.00 <del>$12.40</del></h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace-2/product-sm/2.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Black Digital Watch</h6>
                                        </a>
                                        <h4>$56.20</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace-2/product-sm/3.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Silver Digital Watch</h6>
                                        </a>
                                        <h4>$60.10</h4>
                                    </div>
                                </div>
                    ...
                    <div class="theme-card">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace-2/product-sm/4.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Black Eyeglasses</h6>
                                        </a>
                                        <h4>$10.00 <del>$12.40</del></h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace-2/product-sm/5.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Gradiant Glassses</h6>
                                        </a>
                                        <h4>$56.20</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace-2/product-sm/6.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6> RAY-BAN Eyeglasses</h6>
                                        </a>
                                        <h4>$60.10</h4>
                                    </div>
                                </div>
                    ...
                    <div class="theme-card">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace-2/product-sm/7.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Children Toy Set</h6>
                                        </a>
                                        <h4>$10.00 <del>$12.40</del></h4>
                                    </div>
                                </div>
                                ...
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace-2/product-sm/9.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6> Military Truck Toy</h6>
                                        </a>
                                        <h4>$12.10</h4>
                                    </div>
                                </div>
                    ...
                    <div class="theme-card">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace-2/product-sm/10.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Whispers of the Wild</h6>
                                        </a>
                                        <h4>$1.00 <del>$2.40</del></h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace-2/product-sm/11.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Secrets of Success</h6>
                                        </a>
                                        <h4>$3.40</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(accordian).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace-2/product-sm/12.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
    ...
    <section class="bag-product section-b-space ratio_square">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="title-basic">
                        <h2 class="title font-fraunces"><i class="ri-flashlight-fill"></i> Big Savings</h2>
                    </div>
                </div>
                <div class="col-12">
                    <div class="g-3 g-md-4 row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                        <div>
                            <div class="basic-product theme-product-6">
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 8.79<del> $10.00 </del><span class="discounted-price"> 6% Off
                                        </span>
                                    </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 2.50<del> $3.00 </del><span class="discounted-price"> 7% Off
                                        </span>
                                    </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
                ...
                <div class="col-12 section-t-space">
                    <div class="title-basic">
                        <h2 class="title font-fraunces"><i class="ri-flashlight-fill"></i> Top Rated For You</h2>
                    </div>
                </div>
                <div class="col-12">
                    <div class="g-3 g-md-4 row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-2/product/16.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 1.00<del> $2.40 </del><span class="discounted-price"> 6% Off
                                        </span>
                                    </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-2/product/17.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-2/product/18.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 5.00<del> $6.80 </del><span class="discounted-price"> 9% Off
                                        </span>
                                    </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-2/product/19.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 6.80<del> $8.70 </del><span class="discounted-price"> 7% Off
                                        </span>
                                    </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-2/product/20.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                                ...
                                <div class="product-detail">
                                    <a class="product-title" href="product-page(accordian).html">
                                        The Chronicles of Authentic Living
                                    </a>
                                    <div class="rating-w-count">
                                        <div class="rating"><i class="ri-star-fill"></i> <i class="ri-star-fill"></i> <i
                                                class="ri-star-fill"></i>
                                    ...
                                    <h4 class="price">$ 6.19<del> $8.00 </del><span class="discounted-price"> 7% Off
                                        </span>
                                    </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
    ...
    <section class="pt-0 section-b-space">
        <div class="container">
            <a href="category-page.html" class="full-banner">
                <img src="../assets/images/marketplace-2/full-banner/2.png" alt="" class="img-fluid blur-up lazyload">
