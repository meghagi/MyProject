                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card mb-0 mt-0">
                                    <div class="card-body">
                                        <div class="top-sec">
                                            <form action="{{ route('updatedata2', ['id' => $category->id]) }}" name="myForm" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row mb-3 align-items-center">
                                                    <div class="col-xxl-2 col-lg-12 col-md-3">
                                                        <label for="Customername" class="form-label">Category Name</label>
                                                    </div>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="name" class="form-control" name="categoryname" value="{{$category->category_name}}" placeholder="Enter Cat4egory Name">
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="description" class="form-control" name="description"value="{{$category->description}}" placeholder="Enter Email">
                                                        <span class="text-danger">
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="price" class="form-control" name="price" value="{{$category->price}}"placeholder="Enter price">
                                                        <span class="text-danger">
