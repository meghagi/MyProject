    ...
    <section class="p-0 layout-7">
        <a href="category-page.html" class="home">
            <img src="../assets/images/marketplace-4/full-banner/1.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- Home slider end -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="title-basic">
                        <h2 class="title font-fraunces"><i class="ri-flashlight-fill"></i> deals of the day</h2>
                        <div class="timer">
                            <p id="demo"></p>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="product-5 game-product product-m no-arrow">
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-4/product/1.jpg"
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 5.90<del> $8.00 </del><span class="discounted-price"> 10% Off
                                        </span>
                                    </h4>
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-4/product/2.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 6.14<del> $9.38 </del><span class="discounted-price"> 9% Off
                                        </span>
                                    </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-4/product/3.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-4/product/4.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 10.69<del> $14.00 </del><span class="discounted-price"> 12% Off
                                        </span>
                                    </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
                        ...
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
                                    <a href="#!"><img src="../assets/images/marketplace-4/product/5.jpg"
                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    <div class="cart-info">
                                        <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                        <a href="#quickView" data-bs-toggle="modal" title="Quick View"><i
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4 class="price">$ 12.16<del> $15.00 </del>
                                    </h4>
                                    <div class="addtocart_btn">
                                        <button class="add-button add_cart" title="Add to cart">
                                            Add to Cart
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <a href="category-page.html">
                        <img src="../assets/images/marketplace-4/banner/1.png"
                            class="img-fluid blur-up object-fit-cover lazyload h-100" alt="">
                    </a>
                </div>
                <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                    <div class="product-four game-product product-m no-arrow">
                        <div>
                            <div class="basic-product theme-product-6">
                                <div class="img-wrapper">
                                    <label class="unit-label">1 Item</label>
    ...
    <section class="section-b-space">
        <img src="../assets/images/marketplace-4/full-banner/2.png" alt="" class="bg-img blur-up lazyload">
                                ...
                                <div>
                                    <div class="media">
                                        <a href="product-page(accordian).html"><img alt=""
                                                ...
                                                src="../assets/images/marketplace-4/product-sm/1.jpg"></a>
                                    ...
                                    <div class="media">
                                        <a href="product-page(accordian).html"><img alt=""
                                                class="img-fluid blur-up lazyload"
                                                src="../assets/images/marketplace-4/product-sm/2.jpg"></a>
                                        <div class="media-body align-self-center">
                                            <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i>
                                ...
                                <div>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body align-self-center">
                                            ...
                                            <a href="product-page(accordian).html">
                                                <h6>White Wireless Bluetooth Headphone</h6>
                                            </a>
                                            <h4>$100.00</h4>
                                        </div>
                                    </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-12">
                            <a href="category-page.html">
                                <div class="collection-banner">
                                    <div class="img-part">
                                        <img src="../assets/images/marketplace-4/banner/2.png" alt=""
                        ...
                        <div class="col-md-12">
                            <a href="category-page.html">
                                <div class="collection-banner">
                                    <div class="img-part">
                                        <img src="../assets/images/marketplace-4/banner/3.png" alt=""
                                            class="img-fluid blur-up lazyload w-100">
                                    </div>
                                </div>
                            </a>
        ...
        <div class="container">
            <div class="row section-b-space">
                <div class="col-lg-3 col-md-4 col-sm-5 col-6">
                    <a href="category-page.html">
                        <img src="../assets/images/marketplace-4/banner/4.png" class="img-fluid blur-up h-100 lazyload"
                            alt="">
                    </a>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 p-0">
                    ...
                    <div class="slide-7 no-arrow slick-instagram">
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/marketplace-4/instagram/1.png"
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/marketplace-4/instagram/2.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/marketplace-4/instagram/3.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/marketplace-4/instagram/4.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/marketplace-4/instagram/5.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"><img src="../assets/images/marketplace-4/instagram/6.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
