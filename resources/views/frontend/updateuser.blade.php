                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card mb-0 mt-0">
                                    <div class="card-body">
                                        <div class="top-sec">
                                            <form action="{{ route('updateuserdata', ['id' => $user->id]) }}" name="myForm" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="name" class="form-control" name="name" value="{{$user->name}}" placeholder="Enter Product Name">
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="Email" class="form-control" name="email"value="{{$user->email}}" placeholder="Enter Email">
                                                        <span class="text-danger">
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="phonenumber" class="form-control" name="phonenumber" value="{{$user->phonenumber}}"placeholder="Enter contactnumber">
                                                        <span class="text-danger">
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    <div class="col-xxl-2 col-lg-12 col-md-3">
                                                        <label for="cost" class="form-label">adderess</label>
                                                    </div>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="adderess" class="form-control" name="adderess" value="{{$user->adderess}}"placeholder="Enter DOB">
                                                        <span class="text-danger">
