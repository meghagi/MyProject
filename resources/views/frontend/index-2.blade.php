        ...
        <div class="slide-1 home-slider">
            <div>
                <a href="category-page.html" class="home">
                    <img src="../assets/images/fashion-1/full-banner/1.png" alt="" class="bg-img blur-up lazyload">
                </a>
            </div>
            <div>
                <a href="category-page.html" class="home">
                    <img src="../assets/images/fashion-1/full-banner/2.png" alt="" class="bg-img blur-up lazyload">
                </a>
            </div>
        </div>
    </section>
            ...
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="category-page.html" class="collection-banner">
                        <img src="../assets/images/fashion-1/banner/1.png" class="img-fluid blur-up lazyload" alt="">
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="category-page.html" class="collection-banner">
                        <img src="../assets/images/fashion-1/banner/2.png" class="img-fluid blur-up lazyload" alt="">
                    </a>
                </div>
            </div>
        </div>
    ...
    <section class="pt-0">
        <a href="category-page.html">
            <img src="../assets/images/fashion-1/full-banner/3.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- full banner end -->
