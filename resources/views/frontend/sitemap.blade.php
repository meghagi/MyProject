                    ...
                    <ul>
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="product-page(accordian).html">no sidebar</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#!"> thumbnail image</a>
                            <ul>
                                <li><a href="product-page(thumbnail).html">left image</a></li>
                        ...
                        <li>
                            ...
                            <ul>
                                <li><a href="product-page(thumbnail).html">thumbnail left</a></li>
                        ...
                        <li><a href="product-page(sticky).html">
                                sticky</a></li>
                        <li><a href="product-page(accordian).html">accordion</a></li>
                ...
                <div class="col-md-3 col-6">
                    ...
                    <ul>
                        <li>
                            <a href="#!"> account</a>
                            <ul>
                                <li><a href="product-page(thumbnail).html">account</a></li>
