  ...
  @section('main-container')  
    ...
    <section class="p-0">
        <a href="category-page.html" class="home text-center">
            <img src="../assets/images/flower/full-banner/1.png" alt="" class="img-fluid">
        </a>
    </section>
            ...
            <div class="row partition2">
                <div class="col-md-4">
                    <a href="category-page.html">
                        <div class="collection-banner ">
                            <div class="img-part">
                                <img src="../assets/images/flower/banner/1.png" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-8">
                    <a href="category-page.html">
                        <div class="collection-banner">
                            <div class="img-part">
                                <img src="../assets/images/flower/banner/2.png" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                        </div>
                    </a>
                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/flower/product/1.png"
                            ...
                            <div>
                                <div class="basic-product theme-product-1">
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/flower/product/2.png"
                                                    class="img-fluid blur-up lazyload " alt=""></a>
                                            <div class="rating-label"><i class="fa fa-star"></i>
                                                <span>4.5</span>
                                            </div>
                            ...
                            <div>
                                <div class="basic-product theme-product-1">
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/flower/product/3.png"
                                                    class="img-fluid blur-up lazyload " alt=""></a>
                                            <div class="rating-label"><i class="fa fa-star"></i>
                                                <span>4.5</span>
                                            </div>
                            ...
                            <div>
                                <div class="basic-product theme-product-1">
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/flower/product/4.png"
                                                    class="img-fluid blur-up lazyload " alt=""></a>
                                            <div class="rating-label"><i class="fa fa-star"></i>
                                                <span>4.5</span>
                                            </div>
                            ...
                            <div>
                                <div class="basic-product theme-product-1">
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    src="../assets/images/flower/product/5.png"
                                                    class="img-fluid blur-up lazyload " alt=""></a>
                                            <div class="rating-label"><i class="fa fa-star"></i>
                                                <span>4.5</span>
                                            </div>
                    ...
                    <div class="col">
                        ...
                        <div class="theme-tab">
                            <ul class="tabs tab-title">
                                <li class="current"><a href="tab-7.html">Anniversary Bouquets</a></li>
                                <li><a href="tab-8.html">Get Well Soon Bouquets</a></li>
                            </ul>
                                            ...
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(accordian).html"><img
                                                            ...
                                                            src="../assets/images/flower/product/6.png" alt=""></a>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(accordian).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="../assets/images/flower/product/7.png" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(accordian).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="../assets/images/flower/product/8.png" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(accordian).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="../assets/images/flower/product/9.png" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i>
                                                        ...
                                                        <a href="product-page(accordian).html">
                                                            <h6>Mixed flower Bouquet</h6>
                                                        </a>
                                                        <h4>$24.80 <del>$26.00</del></h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/flower/blog/1.png" class="img-fluid blur-up lazyload"
                                            alt="">
                                        <span></span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/flower/blog/2.png" class="img-fluid blur-up lazyload"
                                            alt="">
                                        <span></span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/flower/blog/3.png" class="img-fluid blur-up lazyload"
                                            alt="">
                                        <span></span>
                                    </div>
                                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="slide-5 no-arrow slick-instagram">
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/flower/instagram/1.png" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/flower/instagram/2.png" class="bg-img" alt="Avatar"
                                        style="width:100%">
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/flower/instagram/3.png" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/flower/instagram/4.png" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/flower/instagram/5.png" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
