...
<li role="presentation" class="nav-item">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="faq-content tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="manage-customer-tab-pane" role="tabpanel">
                            <div class="row g-3">
                                <div class="col-12">
...
<a href="{{Route('deletecustomer',['id'=>$customers->id])}}"title="Change Status" id="{{$customers->id}}"class="delete_btn_ajax1 " data-toggle="tooltip"><span class="fas fa-trash" style="color:red;"></a><input type="hidden" class="delete_id_value" value='{{$customers->id}}'>


    <a href="{{Route('editcustomer',['id'=>$customers->id])}}"  title="Edit Details" data-toggle="tooltip">
        <span class="fa fa-pencil" style="color: yellow;"></span>
                            </a>

                            <a href="{{Route('readcustomer',['id'=>$customers->id])}}"  title="Edit Details" data-toggle="tooltip">
