            ...
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card mb-0 mt-0">
                                    <div class="card-body">
                                        <div class="top-sec">
                                            <form action="{{ route('updatedata1', ['id' => $customers->id]) }}" name="myForm" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="name" class="form-control" name="customername" value="{{$customers->name}}" placeholder="Enter Product Name">
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="Email" class="form-control" name="Email"value="{{$customers->email}}" placeholder="Enter Email">
                                                        <span class="text-danger">
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    <div class="col-xxl-2 col-lg-12 col-md-3">
                                                        <label for="quantity" class="form-label">contactnumber</label>
                                                    </div>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="contactnumber" class="form-control" name="contactnumber" value="{{$customers->contactnumber}}"placeholder="Enter contactnumber">
                                                        <span class="text-danger">
                                                            @error('contactnumber') {{ $message }} @enderror
                                                        </span>
                                                    </div>
                                                </div>
               ...
               {{ $customers->gender == 'Female' ? 'checked' : '' }}>
                                           ...
                                           <span class="text-danger" >
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    <div class="col-xxl-2 col-lg-12 col-md-3">
                                                        <label for="cost" class="form-label">DOB</label>
                                                    </div>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="dob" class="form-control" name="DOB" value="{{$customers->DOB}}"placeholder="Enter DOB">
                                                        <span class="text-danger">
