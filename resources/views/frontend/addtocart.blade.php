...
<!-- header end -->
            ...
            <div class="row">
                        ...
                        <div class="faq-tab">
                            <ul id="pills-tab" role="tablist" class="nav nav-tabs">
                              ...
                              {{-- <li role="presentation" class="nav-item">
                                ...
                                <a href="{{url('/addwishlist')}}"> <li role="presentation" class="nav-item">
                                ...
                                <a href="{{url('/productDetail')}}"> <li role="presentation" class="nav-item">
                                 <button class="nav-link" id="wishlist-tab" data-bs-toggle="tab"
                                        data-bs-target="#wishlist-tab-pane" type="button" role="tab">
                                        <i class="fa-solid fa-box"></i> Product Detail
                ...
                <div class="col-lg-9">
                    ...
                    <div class="faq-content tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="addtocart-tab-pane" role="tabpanel">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card mb-0 mt-0">
                                        <div class="card-body">
                                            ...
                                            <form   action="{{url('/addtocartstore')}}"name="myForm" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row mb-3 align-items-center">
    ...
    <div class="col-xxl-10 col-lg-12 col-md-9">
        ...
        <select name="productid" id="productid" class="form-select">
            ...
            <option value="1">{{$products->id}}</option>
