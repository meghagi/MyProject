            ...
            <div class="container">
                ...
                <nav class="theme-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Category slider</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-3 col-xl-3 col-lg-4 collection-filter">
                            ...
                            <div class="collection-filter-block position-relative mb-4">
        ...
        <div class="container">
            ...
            <nav class="theme-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Category slider</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="product-category-slider no-arrow">
                <div>
                    <a href="#!" class="category-box">
                        <img src="../assets/images/category/1.png" class="img-fluid" alt="Category">
                        <h5>Baby Essentials</h5>
                    </a>
                </div>
                <div>
                    <a href="#!" class="category-box">
                        <img src="../assets/images/category/2.png" class="img-fluid" alt="Category">
                        <h5>Bag Emporium</h5>
                    </a>
                </div>
                <div>
                    <a href="#!" class="category-box">
                        <img src="../assets/images/category/3.png" class="img-fluid" alt="Category">
                        <h5>Christmas</h5>
                    </a>
                </div>
                <div>
                    <a href="#!" class="category-box">
                        <img src="../assets/images/category/4.png" class="img-fluid" alt="Category">
                        <h5>Classic Furnishings</h5>
                    </a>
                </div>
                <div>
                    <a href="#!" class="category-box">
                        <img src="../assets/images/category/5.png" class="img-fluid" alt="Category">
                        <h5>Fashion</h5>
                    </a>
                </div>
                <div>
                    <a href="#!" class="category-box">
                        <img src="../assets/images/category/6.png" class="img-fluid" alt="Category">
                        <h5>Fit Gear Central</h5>
                    </a>
                </div>
                <div>
                    <a href="#!" class="category-box">
                        <img src="../assets/images/category/7.png" class="img-fluid" alt="Category">
                        <h5>Hybrid Bicycle</h5>
                    </a>
                </div>
                <div>
                    <a href="#!" class="category-box">
                        <img src="../assets/images/category/8.png" class="img-fluid" alt="Category">
                        <h5>Lingerie</h5>
                    </a>
                </div>
                <div>
                    <a href="#!" class="category-box">
                        <img src="../assets/images/category/9.png" class="img-fluid" alt="Category">
                        <h5>Mechanical Car Products</h5>
                    </a>
                </div>
                <div>
                    <a href="#!" class="category-box">
                        <img src="../assets/images/category/10.png" class="img-fluid" alt="Category">
                        <h5>Medical Essentials</h5>
                    </a>
                </div>
                <div>
                    <a href="#!" class="category-box">
                        <img src="../assets/images/category/11.png" class="img-fluid" alt="Category">
                        <h5>Perfume</h5>
                    </a>
                </div>
                <div>
                    <a href="#!" class="category-box">
                        <img src="../assets/images/category/12.png" class="img-fluid" alt="Category">
                        <h5>Radiant Ornaments</h5>
                    </a>
                </div>
            </div>
        </div>
