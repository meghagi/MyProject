                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card mb-0 mt-0">
                                    <div class="card-body">
                                        <div class="top-sec">
                                            <form action="{{ route('updatedata3', ['id' => $sales->id]) }}" name="myForm" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="name" class="form-control" name="product_name" value="{{$sales->product_name}}" placeholder="Enter Cat4egory Name">
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="description" class="form-control" name="quantity"value="{{$sales->quantity}}" placeholder="Enter Email">
                                                        <span class="text-danger">
                                                ...
                                                <div class="row mb-3 align-items-center">
                                                    <div class="col-xxl-2 col-lg-12 col-md-3">
                                                        <label for="price" class="form-label">salesprice</label>
                                                    </div>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="text" id="salesprice" class="form-control" name="salesprice" value="{{$sales->salesprice}}"placeholder="Enter price">
                                                        <span class="text-danger">
                                                            @error('salesprice') {{ $message }} @enderror
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xxl-10 col-lg-12 col-md-9">
                                                    <input type="text" id="ifsc" class="form-control" value="{{$sales->discount}}"placeholder="Enter discount" name="discount"
                                            ...
                                            <div class="row mb-3 align-items-center">
                                                    ...
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <select name="status"value="{{$sales->status}}"placeholder="Enter status">
