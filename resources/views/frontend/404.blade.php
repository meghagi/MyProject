...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2024 09:25:32 GMT -->
<head>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="error-section">
                        ...
                        <a href="index-2.html" class="btn btn-solid">back to home</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="sub-title">
                            ...
                            <div class="footer-content">
                                <ul>
                                    ...
                                    <li><a href="product-page(thumbnail).html" class="text-content">Christmas</a>
                                    </li>
                        ...
                        <div class="sub-title">
                            ...
                            <div class="footer-content">
                                ...
                                <form novalidate="" class="form-inline">
                                    ...
                                    <button class="btn btn-solid mb-2" id="subscribe" type="submit">Subscribe</button>
                                </form>
                                    ...
                                    <div class="overflow-hidden">
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html"><img
                                                    ...
                                                    class="img-fluid blur-up lazyloaded" alt=""></a>
                                            <div class="rating-label"><i class="ri-star-fill"></i>
                                                <span>3.7</span>
                                            </div>
                                            <div class="cart-info">
                                                <a href="#!" title="Add to Wishlist" class="wishlist-icon">
