        ...
        <div class="slide-1 home-slider">
            @foreach ($products as $product)
                <div class="product-item">
                    <a href="{{ route('index', $product->id) }}">
                        <img src="{{ asset('uploads/' . $product->file1) }}" alt="{{ $product->name }}" class="product-image" style="">
                        <h2>{{ $product->name }}</h2>
                    </a>
{{--                    
                    <a href="{{ url('/product-page(4-image)') }}">
                        <img src="{{ asset('uploads/img2.jpg') }}" alt="Default Product" class="product-image bg-img " style="height:1200px;">
                ...
                {{-- <a href="{{ url('/product-page(4-image)') }}">
                    <img src="{{ asset('uploads/img2.jpg') }}" alt="Default Product" class="product-image bg-img " >
                    <h2>Default Product</h2>
                </a> --}}
            ...
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="{{url('/stationary')}}" class="collection-banner">
                        <img src="{{ asset('uploads/img2.jpg' ) }}" class="img-fluid blur-up lazyload" alt="">
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="{{url('/colourfulpencil')}}" class="collection-banner">
                        <img src="{{ asset('uploads/im4.jpg' ) }}" class="img-fluid blur-up lazyload" alt=""style="width:200%; height:200%;">
                    </a>
                        {{-- <a href="" 
   title="Edit Details" 
   data-toggle="tooltip" 
   ...
   <span class="fa fa-eye" style="color: white;"></span> View Details
</a> --}}

    {{-- <a href="{{ route('product-page(accordian)')}}" 
       title="Edit Details" 
       class="btn btn-primary btn-sm">
            ...
            <div class="g-3 g-md-4 row row-cols-2 row-cols-md-3 row-cols-xl-4">
                ...
                <div>
                    <div class="basic-product theme-product-1">
                        <div class="overflow-hidden">
                            <div class="img-wrapper">
                                <a href="{{url('books/{id?}')}}" ><img
                                        src="{{ asset('uploads/img6.jpg' ) }}"
                            ...
                            <div class="product-detail">
                                <div>
                                    <div class="brand-w-color">
                                        <a class="product-title" href="{{url('/books/{id?}')}}">
                                            Books
                                        </a>
                ...
                <div>
                    <div class="basic-product theme-product-1">
                        <div class="overflow-hidden">
                            <div class="img-wrapper">
                                <div class="ribbon"><span>Exclusive</span></div>
                                <a href="{{url('/pencil')}}"><img
                                        src="{{ asset('uploads/pencil.jpeg' ) }}"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="rating-label"><i class="ri-star-s-fill"></i> <span>4.5</span>
                                </div>
                                <div class="cart-info">
    ...
    <section class="pt-0">
        <a href="category-page.html">
            <img src="#" alt="" class="img-fluid blur-up lazyload"style="width:200%;">
        </a>
    </section>
    <!-- full banner end -->
                ...
                <div class="col">
                    <div class="theme-tab">
                        <ul class="tabs tab-title">
                            <li class="current"><a href="tab-4.html">Notebooks</a></li>
            ...
            <div class="row">
                <div class="col-md-12 p-0">
                    ...
                    <div class="slide-7 no-arrow slick-instagram">
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="../assets/images/fashion-1/instagram/1.png"
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="../assets/images/fashion-1/instagram/2.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="../assets/images/fashion-1/instagram/3.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="../assets/images/fashion-1/instagram/4.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="../assets/images/fashion-1/instagram/5.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="../assets/images/fashion-1/instagram/6.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="../assets/images/fashion-1/instagram/7.png"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
