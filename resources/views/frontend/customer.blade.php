                                ...
                                <div class="col-12">
                                    <div class="card mb-0 mt-0">
                                        <div class="card-body">
                                            ...
                                            <form   action="{{url('/customerstore')}}"name="myForm" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row mb-3 align-items-center">
                                                <div class="form-group">
			
                                                    <label for="customername"
                                                        class="form-label col-xxl-2 col-lg-12 col-md-3">Customer Name</label>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                ...
                                                <div class="form-group">
                                                    <label for="Email"
                                                        class="form-label col-xxl-2 col-lg-12 col-md-3">Email
                        </label>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9"><input type="email"
                                                ...
                                                <div class="form-group">
                                                    <label for=Contact"
                                                        ...
                                                        Contact</label>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9"><input type="text"
                                                            id="contact" class="form-control" name="contactnumber"
                                                ...
                                                <div class="form-group">
                                                    <label for="DOB"
                                                        class="form-label col-xxl-2 col-lg-12 col-md-3">DOB</label>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                        <input type="date" id="swift" class="form-control" name="DOB"
                                                ...
                                                <div class="form-group">
                                                    <label for="gender"
                                                        class="form-label col-xxl-2 col-lg-12 col-md-3">Gender</label>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
