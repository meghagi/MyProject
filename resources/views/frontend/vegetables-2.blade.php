            ...
            <div class="row">
                    ...
                    <div id="sidebar-height" class="sidenav marketplace-sidebar svg-icon-menu">
                        <nav>
                            ...
                            <ul id="sub-menu" class="sm pixelstrap sm-vertical">
                                <li> <a href="#!"><img src="../assets/images/icon/vegetables/1.jpg"
                                            class="img-fluid me-2" alt="">fruits & vegetable</a>
                                ...
                                <li> <a href="#!"><img src="../assets/images/icon/vegetables/2.jpg"
                                            class="img-fluid me-2" alt="">eggs, meat, fish</a>
                                    <ul>
                                ...
                                <li> <a href="#!"><img src="../assets/images/icon/vegetables/3.jpg"
                                ...
                                <li> <a href="#!"><img src="../assets/images/icon/vegetables/4.jpg"
                                ...
                                <li><a href="#!"><img src="../assets/images/icon/vegetables/5.jpg"
                                            class="img-fluid me-2" alt="">beverages</a></li>
                                <li> <a href="#!"><img src="../assets/images/icon/vegetables/6.jpg"
                                ...
                                <li><a href="#!"><img src="../assets/images/icon/vegetables/7.jpg"
                                            class="img-fluid me-2" alt="">beauty product</a></li>
                                <li><a href="#!"><img src="../assets/images/icon/vegetables/8.jpg"
                                            class="img-fluid me-2" alt="">gourment</a></li>
                                <li><a href="#!"><img src="../assets/images/icon/vegetables/9.jpg"
                                            class="img-fluid me-2" alt="">Kitchen Appliances</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                <div class="col-xl-9">
                    <a href="category-page.html" class="home">
                        <img src="../assets/images/vegetables-2/banner/1.png" alt=""
                ...
                <div class="col-12">
                    ...
                    <div class="product-5 product-m no-arrow">
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/vegetables-1/product/1.png"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <a href="#quickView" class="quick-option" data-bs-toggle="modal" title="Quick View">
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/vegetables-1/product/2.png"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <a href="#quickView" class="quick-option" data-bs-toggle="modal" title="Quick View">
                                    <i class="ri-search-line"></i>
                                </a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/vegetables-1/product/3.png"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <a href="#quickView" class="quick-option" data-bs-toggle="modal" title="Quick View">
                                    <i class="ri-search-line"></i>
                                </a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/vegetables-1/product/4.png"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <a href="#quickView" class="quick-option" data-bs-toggle="modal" title="Quick View">
                                    <i class="ri-search-line"></i>
                                </a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/vegetables-1/product/5.png"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <a href="#quickView" class="quick-option" data-bs-toggle="modal" title="Quick View">
                                    <i class="ri-search-line"></i>
                                </a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/vegetables-1/product/6.png"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <a href="#quickView" class="quick-option" data-bs-toggle="modal" title="Quick View">
                                    <i class="ri-search-line"></i>
                                </a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/vegetables-1/product/7.png"
                                        class="img-fluid blur-up lazyload " alt=""></a>
                                <a href="#quickView" class="quick-option" data-bs-toggle="modal" title="Quick View">
                                    <i class="ri-search-line"></i>
                                </a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/vegetables-1/product/8.png"
                                        class="img-fluid blur-up lazyload " alt=""></a>
                                <a href="#quickView" class="quick-option" data-bs-toggle="modal" title="Quick View">
                                    <i class="ri-search-line"></i>
                                </a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/vegetables-1/product/9.png"
                                        class="img-fluid blur-up lazyload " alt=""></a>
                                <a href="#quickView" class="quick-option" data-bs-toggle="modal" title="Quick View">
                                    <i class="ri-search-line"></i>
                                </a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/vegetables-1/product/10.png"
                                        class="img-fluid blur-up lazyload " alt=""></a>
                                <a href="#quickView" class="quick-option" data-bs-toggle="modal" title="Quick View">
                                    <i class="ri-search-line"></i>
                                </a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/vegetables-1/product/11.png"
                                        class="img-fluid blur-up lazyload " alt=""></a>
                                <a href="#quickView" class="quick-option" data-bs-toggle="modal" title="Quick View">
                                    <i class="ri-search-line"></i>
                                </a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/vegetables-1/product/12.png"
                                        class="img-fluid blur-up lazyload " alt=""></a>
                                <a href="#quickView" class="quick-option" data-bs-toggle="modal" title="Quick View">
                                    <i class="ri-search-line"></i>
                                </a>
            ...
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="category-page.html" class="collection-banner">
                        <img src="../assets/images/vegetables-2/banner/2.png" class="img-fluid blur-up lazyload w-100"
                            alt="">
                ...
                <div class="col-md-6">
                    <a href="category-page.html" class="collection-banner">
                        <img src="../assets/images/vegetables-2/banner/3.png" class="img-fluid blur-up lazyload w-100"
                            alt="">
        ...
        <div class="banner-goggles banner-padding ratio2_1">
            <div class="container">
                <div class="row g-4">
                    <div class="col-md-4">
                        <a href="category-page.html" class="collection-banner">
                            <img src="../assets/images/vegetables-2/banner/4.png"
                    ...
                    <div class="col-md-4">
                        <a href="category-page.html" class="collection-banner">
                            <img src="../assets/images/vegetables-2/banner/5.png"
                                class="img-fluid blur-up lazyload w-100" alt="">
                    ...
                    <div class="col-md-4">
                        <a href="category-page.html" class="collection-banner">
                            <img src="../assets/images/vegetables-2/banner/6.png"
                                class="img-fluid blur-up lazyload w-100" alt="">
                    ...
                    <div class="theme-tab">
                        <div class="bg-title-part title-basic">
                            ...
                            <ul class="tabs tab-title">
                                <li class="current">
                                    <a href="tab-4.html">Fruits</a>
                                </li>
                                <li>
                                    <a href="tab-5.html">Vegetables</a>
                                </li>
                            </ul>
                        </div>
    ...
    <section class="container">
        <a href="category-page.html" class="full-banner p-0 p-left">
            <img src="../assets/images/vegetables-2/full-banner/1.png" alt="" class="img-fluid w-100 blur-up lazyload">
        </a>
    </section>
    <!-- banner section end -->
    ...
    <section class="addtocart_count ratio_square">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="title-basic">
                        <h2 class="title font-fraunces"><i class="ri-flashlight-fill"></i> recently viewd</h2>
                    </div>
                </div>
                <div class="col-12">
                    <div class="product-5 product-m no-arrow">
    ...
    <!-- blog section -->
    <section class="blog section-b-space gym-blog ratio3_2 slick-default-margin">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="title-basic">
                        <h2 class="title font-fraunces"><i class="ri-flashlight-fill"></i> featured recipes</h2>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="slide-4 no-arrow">
                        <div>
                            <a href="blog-details.html">
                                <div class="basic-effect">
                                    <div>
                                        <img src="../assets/images/vegetables-2/blog/1.png"
                            ...
                            <div class="blog-details">
                                ...
                                <a href="#!">
                                    <p>Supercharge Your Meals: Incorporating Colorful Vegetables and Fruits</p>
                                </a>
                        ...
                        <div>
                            <a href="blog-details.html">
                                <div class="basic-effect">
                                    <div>
                                        <img src="../assets/images/vegetables-2/blog/2.png"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                            ...
                            <div class="blog-details">
                                <h4>25 Feb 2024</h4>
                                <a href="#!">
                                    <p>Nourishing from Within: A Journey to Feed Your Cells and Soul</p>
                                </a>
                                <h6>by: John Dio , 2 Comment</h6>
                            </div>
                        </div>
                        <div>
                            <a href="blog-details.html">
                                <div class="basic-effect">
                                    <div>
                                        <img src="../assets/images/vegetables-2/blog/3.png"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                            ...
                            <div class="blog-details">
                                <h4>10 January 2024</h4>
                                <a href="#!">
                                    <p>Mastering the Art of Efficient Grocery Shopping: Expert Tips and Tricks</p>
                                </a>
                                <h6>by: John Dio , 2 Comment</h6>
                            </div>
                        </div>
