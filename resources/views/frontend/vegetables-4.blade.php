    ...
    <section class="p-0 small-slider">
        <a href="category-page.html">
            <img src="../assets/images/vegetables-4/full-banner/1.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- Home slider end -->
            ...
            <div class="vector-slide-8 no-arrow slick-default-margin ratio_square">
                <div>
                    <a href="category-page(vegetables).html">
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="../assets/images/icon/vegetables/veg.png" class="img-fluid" alt="">
                            </div>
                            <h4>Vegetables</h4>
                        </div>
                    </a>
                ...
                <div>
                    <a href="category-page(vegetables).html">
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="../assets/images/icon/vegetables/dairy.png" class="img-fluid" alt="">
                            </div>
                            <h4>Dairy</h4>
                        </div>
                    </a>
                ...
                <div>
                    <a href="category-page(vegetables).html">
                        ...
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="../assets/images/icon/vegetables/meat.png" class="img-fluid" alt="">
                            </div>
                            <h4>meat</h4>
                        </div>
                    </a>
                ...
                <div>
                    <a href="category-page(vegetables).html">
                        ...
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="../assets/images/icon/vegetables/care.png" class="img-fluid" alt="">
                            </div>
                            <h4>care</h4>
                        </div>
                    </a>
                ...
                <div>
                    <a href="category-page(vegetables).html">
                        ...
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="../assets/images/icon/vegetables/cleaning.png" class="img-fluid" alt="">
                            </div>
                            <h4>cleaning</h4>
                        </div>
                    </a>
                ...
                <div>
                    <a href="category-page(vegetables).html">
                        ...
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="../assets/images/icon/vegetables/noodle.png" class="img-fluid" alt="">
                            </div>
                            <h4>noodle</h4>
                        </div>
                    </a>
                ...
                <div>
                    <a href="category-page(vegetables).html">
                        ...
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="../assets/images/icon/vegetables/pet.png" class="img-fluid" alt="">
                            </div>
                            <h4>pet</h4>
                        </div>
                    </a>
                ...
                <div>
                    <a href="category-page(vegetables).html">
                        ...
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="../assets/images/icon/vegetables/tea.png" class="img-fluid" alt="">
                            </div>
                            <h4>tea</h4>
                        </div>
                    </a>
            ...
            <div class="row g-4">
                <div class="col-6 col-lg-4">
                    <a href="category-page.html">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../assets/images/vegetables-4/banner/1.png"
                ...
                <div class="col-6 col-lg-4">
                    <a href="category-page.html">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../assets/images/vegetables-4/banner/2.png"
                                    class="img-fluid blur-up lazyload w-100" alt="">
                            </div>
                ...
                <div class="col-6 col-lg-4">
                    <a href="category-page.html">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../assets/images/vegetables-4/banner/3.png"
                                    class="img-fluid blur-up lazyload w-100" alt="">
                            </div>
                    ...
                    <div class="product-5 product-m no-arrow">
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper">
                                ...
                                <a href="#!" class="quick-option" data-bs-toggle="modal" data-bs-target="#quickView"
                                    title="Quick View"><i class="ri-search-line"></i></a>
                            </div>
                        ...
                        <div class="basic-product theme-product-7">
                            ...
                            <div class="product-detail">
                                ...
                                <div class="product-action">
                                    <a href="#!" title="Add to Wishlist"><i class="ri-heart-line"></i></a>
                                    <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i
                                            class="ri-shopping-cart-line"></i>Add to
                                        cart</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row partition2">
                    <div class="col-md-4">
                        <a href="category-page.html">
                            <div class="collection-banner p-right text-center">
                                <div class="img-part">
                                    <img src="../assets/images/vegetables-4/banner/4.png"
                    ...
                    <div class="col-md-4">
                        <a href="category-page.html">
                            <div class="collection-banner p-right text-center">
                                <div class="img-part">
                                    <img src="../assets/images/vegetables-4/banner/5.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a href="category-page.html">
                            <div class="collection-banner p-right text-center">
                                <div class="img-part">
                                    <img src="../assets/images/vegetables-4/banner/6.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </div>
                            </div>
                        </a>
    ...
    <section class="bag-product ratio_square deal-product-space section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="title8">
                        <h2>Lowest Price Vegetables & Fruites</h2>
                        <p>atta, dal, rice and more</p>
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <div class="slide-4 no-arrow">
                        <div>
                            <a href="blog-details.html">
                                <div class="basic-effect">
                                    <div>
                                        <img src="../assets/images/vegetables-4/blog/1.png"
                        ...
                        <div>
                            <a href="blog-details.html">
                                <div class="basic-effect">
                                    <div>
                                        <img src="../assets/images/vegetables-4/blog/2.png"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                        ...
                        <div>
                            <a href="blog-details.html">
                                <div class="basic-effect">
                                    <div>
                                        <img src="../assets/images/vegetables-4/blog/3.png"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
