...
<a href="{{url('/customer')}}"> <button class="nav-link" id="customer-tab" data-bs-toggle="tab"
                ...
                <div class="col-lg-9">
                    ...
                    <div class="faq-content tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="add-category-tab-pane" role="tabpanel">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card mb-0 mt-0">
                                        <div class="card-body">
                                            ...
                                            <form   action="{{url('/categorystore')}}"name="myForm" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row mb-3 align-items-center">
                                                <div class="form-group">
			
                                                    <label for="categoryname"
                                                        class="form-label col-xxl-2 col-lg-12 col-md-3"> Name</label>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9">
                                                ...
                                                <div class="form-group">
                                                    <label for="Price"
                                                        ...
                                                        price</label>
                                                    <div class="col-xxl-10 col-lg-12 col-md-9"><input type="text"
                                                            id="quantity" class="form-control" name="price"
