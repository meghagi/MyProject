...
<a href="{{url('/customer')}}"> <button class="nav-link" id="customer-tab" data-bs-toggle="tab"
                               ...
                               <a href="{{url('/orderitem/')}}"> <button class="nav-link" id="order-tab" data-bs-toggle="tab"
                                ...
                                <li role="presentation" class="nav-item">
                                <button class="nav-link" id="manageorderitem-tab" data-bs-toggle="tab"
...
<li role="presentation" class="nav-item">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="faq-content tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="manageorderitem-tab-pane" role="tabpanel">
                            <div class="row g-3">
                                <div class="col-12">
...
<a href="{{Route('deleteorder',['id'=>$orderitems->id])}}"title="Change Status" id="{{$orderitems->id}}"class="delete_btn_ajax " data-toggle="tooltip"><span class="fas fa-trash" style="color:red;"></a><input type="hidden" class="delete_id_value" value='{{$orderitems->id}}'>


    <a href="{{Route('editorder',['id'=>$orderitems->id])}}"  title="Edit Details" data-toggle="tooltip">
        <span class="fa fa-pencil" style="color: yellow;"></span>
                            </a>


                            <a href="{{Route('readorder',['id'=>$orderitems->id])}}"  title="Edit Details" data-toggle="tooltip">
    ...
    var table = $('.yajra_datatable').DataTable({
      ...
      processing: true,
        ...
        columns: [
            ...
            { data: 'salesprice', name: 'salesprice' },
