...
<head>
   ...
   <link rel="stylesheet" href="{{url('assets/css/main.css')}}">
    <link rel="stylesheet" href="{{url('assets/datatablecss/jquery.dataTables.min.css')}}">
   <link rel="stylesheet" href="{{url('assets/datatablecss/dataTables.bootstrap4.min.css')}}">
