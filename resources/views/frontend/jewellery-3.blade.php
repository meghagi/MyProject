    ...
    <section class="p-0 position-relative overflow-hidden">
        <a href="category-page.html">
            <div class="home">
                <img src="../assets/images/jewellery-3/full-banner/1.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- Home slider end -->
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <a href="#!">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../assets/images/jewellery-3/banner/1.png"
                ...
                <div class="col-md-4">
                    <a href="#!">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../assets/images/jewellery-3/banner/2.png"
                                    class="img-fluid blur-up lazyload w-100" alt="">
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-4">
                    <a href="#!">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../assets/images/jewellery-3/banner/3.png"
                                    class="img-fluid blur-up lazyload w-100" alt="">
                            </div>
                        </div>
                    </a>
                ...
                <div class="col">
                    <div class="product-4 product-m no-arrow">
                        <div class="basic-product theme-product-8">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/jewellery-3/product/3.jpg"
                            ...
                            <div class="product-detail">
                                <a class="product-title" href="product-page(accordian).html">
                                    Heart Necklace</a>
                                <h4 class="price mb-2">$ 90.20<del> $95.00 </del><span class="discounted-price"> 10% Off
                                    </span>
                                </h4>
                        ...
                        <div class="basic-product theme-product-8">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/jewellery-3/product/5.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <a href="#!" title="Add to Wishlist" class="wishlist-icon">
                                        <i class="ri-heart-line"></i>
                            ...
                            <div class="product-detail">
                                ...
                                <h4 class="price mb-2">$ 95.30<del> $98.70 </del><span class="discounted-price"> 8% Off
                                    </span>
                                </h4>
                                <div class="rating-w-count mb-0">
                                    <div class="rating"><i class="ri-star-fill"></i> <i class="ri-star-fill"></i> <i
                        ...
                        <div class="basic-product theme-product-8">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/jewellery-3/product/12.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <a href="#!" title="Add to Wishlist" class="wishlist-icon">
                                        <i class="ri-heart-line"></i>
                            ...
                            <div class="product-detail">
                                <a class="product-title" href="product-page(accordian).html">
                                    Multi Pierced Stud Earrings </a>
                                <h4 class="price mb-2">$ 50.49<del> $55.20 </del><span class="discounted-price"> 12% Off
                                    </span>
                                </h4>
                                <div class="rating-w-count mb-0">
                                    <div class="rating"><i class="ri-star-fill"></i> <i class="ri-star-fill"></i> <i
                        ...
                        <div class="basic-product theme-product-8">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/jewellery-3/product/13.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <a href="#!" title="Add to Wishlist" class="wishlist-icon">
                                        <i class="ri-heart-line"></i>
                        ...
                        <div class="basic-product theme-product-8">
                            <div class="img-wrapper">
                                <a href="product-page(accordian).html"><img
                                        src="../assets/images/jewellery-3/product/2.jpg"
                                        class="img-fluid blur-up lazyload" alt=""></a>
                                <div class="cart-info">
                                    <a href="#!" title="Add to Wishlist" class="wishlist-icon">
                                        <i class="ri-heart-line"></i>
                            ...
                            <div class="product-detail">
                                <a class="product-title" href="product-page(accordian).html">
                                    Minimalist Gold Necklace </a>
                                <h4 class="price mb-2">$ 60.35 </h4>
                                <div class="rating-w-count mb-0">
                                    <div class="rating"><i class="ri-star-fill"></i> <i class="ri-star-fill"></i> <i
                                            class="ri-star-fill"></i>
                                        <i class="ri-star-fill"></i> <i class="ri-star-fill"></i>
    ...
    <section class="p-0">
        <a href="#!">
            <img src="../assets/images/jewellery-3/full-banner/2.png" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- full banner end -->

    <!-- tab section start -->
    <section class="ratio_square bag-product">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="theme-tab">
                        <div class="title6">
                            ...
                            <ul class="tabs tab-title">
                                ...
                                <li><a href="tab-2.html">Featured Products</a></li>
                            </ul>
                        </div>
                                ...
                                <div class="product-4 product-m no-arrow">
                                    <div class="basic-product theme-product-8">
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <button class="add-round-btn" data-bs-toggle="modal"
                                    ...
                                    <div class="basic-product theme-product-8">
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <h4 class="price mb-2">$ 95.30<del> $98.70 </del><span
                                    ...
                                    <div class="basic-product theme-product-8">
                                        ...
                                        <div class="product-detail">
                                            <a class="product-title" href="product-page(accordian).html">
                                                Multi Pierced Stud Earrings </a>
                                            <h4 class="price mb-2">$ 50.49<del> $55.20 </del><span
                                                    class="discounted-price"> 12% Off
                                                </span>
                                            </h4>
                                            <div class="rating-w-count mb-0">
                                                <div class="rating"><i class="ri-star-fill"></i> <i
        ...
        <div class="container">
            <div class="row g-4 partition_3">
                <div class="col-lg-4 ratio_square">
                    <div class="theme-card card-border h-100">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center">
                                        ...
                                        <a href="product-page(accordian).html">
                                            <h6>Leaves Sheap Rose Gold bracelet</h6>
                                        </a>
                                        <h4>$240.00</h4>
                                    </div>
                                </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                ...
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Flower Sheap gold And Diamond Pandant</h6>
                                        </a>
                                        <h4>$220.00</h4>
                                    </div>
                                </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                ...
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Star Sheap Gold Rings With Diamond</h6>
                                        </a>
                                        <h4>$280.80</h4>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 center-slider border-0">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="category-page.html">
                                <div class="collection-banner p-left text-start tl-content">
                                    <div class="img-part">
                                        <img src="../assets/images/jewellery-3/banner/4.png" alt=""
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                ...
                                                class="fa fa-star"></i></div>
                                        <a href="product-page(accordian).html">
                                            <h6>Rose Gold 18K Box Sheap Bracelet</h6>
                                        </a>
                                        <h4>$220.10</h4>
                                    </div>
                                </div>
    ...
    <!-- blog section -->
    <section class="blog ratio2_3 gym-blog pt-0 section-b-space slick-default-margin bg-light">
        <div class="container">
            <div class="row section-t-space">
                <div class="col-md-12">
                    <div class="title6">
                        <h2 class="font-cormorant">latest news</h2>
                    </div>
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/jewellery/blog/5.jpg"
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/jewellery/blog/6.jpg"
                                            class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/jewellery/blog/7.jpg"
                                            class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="slide-5 no-arrow slick-instagram">
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/jewellery-3/instagram/1.png" class-fluid="img"
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/jewellery-3/instagram/2.png" class-fluid="img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/jewellery-3/instagram/3.png" class-fluid="img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/jewellery-3/instagram/4.png" class-fluid="img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/jewellery-3/instagram/5.png" class-fluid="img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/jewellery-3/instagram/2.png" class="img-fluid"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/jewellery-3/instagram/3.png" class="img-fluid"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/jewellery-3/instagram/4.png" class="img-fluid"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box">
                                    <img src="../assets/images/jewellery-3/instagram/5.png" class="img-fluid"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay">
                                        <i class="ri-instagram-fill"></i>
                                    </div>
